...
public abstract class ToTIMAbstractTransformer<InputModel extends EObject, InputPackage extends EPackage> extends
        AbstractTransformer<InputModel, InputPackage, Pipeline, CICDPackage> {
