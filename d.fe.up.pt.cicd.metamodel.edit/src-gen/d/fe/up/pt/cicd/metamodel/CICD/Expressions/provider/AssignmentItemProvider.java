/**
 */
package d.fe.up.pt.cicd.metamodel.CICD.Expressions.provider;
...
public class AssignmentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Assignment_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Assignment_value_feature",
								"_UI_Assignment_type"),
						ExpressionsPackage.Literals.ASSIGNMENT__VALUE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.ASSIGNMENT__KEY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.ASSIGNMENT__KEY,
