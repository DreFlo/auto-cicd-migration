...
public class InternalGitHubActionsLexer extends Lexer {
    ...
    public final void mRULE_UNQUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGitHubActionsLexer.g:352:22: ( ( ( 'a..z' | 'A' .. 'Z' | '_' | '~' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '~' )* | '|' ( '+' | '-' )? RULE_NEWLINE RULE_BEGIN ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '\\n' )* RULE_END ) )
            // InternalGitHubActionsLexer.g:352:24: ( ( 'a..z' | 'A' .. 'Z' | '_' | '~' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '~' )* | '|' ( '+' | '-' )? RULE_NEWLINE RULE_BEGIN ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '\\n' )* RULE_END )
            {
            // InternalGitHubActionsLexer.g:352:24: ( ( 'a..z' | 'A' .. 'Z' | '_' | '~' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '~' )* | '|' ( '+' | '-' )? RULE_NEWLINE RULE_BEGIN ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '\\n' )* RULE_END )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalGitHubActionsLexer.g:352:97: '|' ( '+' | '-' )? RULE_NEWLINE RULE_BEGIN ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '\\n' )* RULE_END
                    {
                    match('|'); 
                    ...
                    mRULE_NEWLINE(); 
                    mRULE_BEGIN(); 
                    // InternalGitHubActionsLexer.g:352:136: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' | '@' | '`' | '\\n' )*
                    loop5:
                    do {
                        int alt5=2;
                        int LA5_0 = input.LA(1);

                        if ( (LA5_0=='\n'||(LA5_0>='0' && LA5_0<='9')||(LA5_0>='@' && LA5_0<='Z')||(LA5_0>='_' && LA5_0<='z')) ) {
                            alt5=1;
                        }
                    	...
                    	case 1 :
                    	    // InternalGitHubActionsLexer.g:
                    	    {
                    	    if ( input.LA(1)=='\n'||(input.LA(1)>='0' && input.LA(1)<='9')||(input.LA(1)>='@' && input.LA(1)<='Z')||(input.LA(1)>='_' && input.LA(1)<='z') ) {
                    	        input.consume();
