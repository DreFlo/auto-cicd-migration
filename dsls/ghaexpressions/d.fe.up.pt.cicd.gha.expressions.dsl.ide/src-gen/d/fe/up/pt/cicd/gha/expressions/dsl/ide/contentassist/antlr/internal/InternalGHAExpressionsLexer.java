...
public class InternalGHAExpressionsLexer extends Lexer {
    ...
    public final void mRULE_VARIABLE_REFERENCE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1936:25: ( RULE_ID ( '.' RULE_ID | '[' ( RULE_ID | RULE_INT ) ']' )+ )
            // InternalGHAExpressions.g:1936:27: RULE_ID ( '.' RULE_ID | '[' ( RULE_ID | RULE_INT ) ']' )+
            {
            mRULE_ID(); 
            // InternalGHAExpressions.g:1936:35: ( '.' RULE_ID | '[' ( RULE_ID | RULE_INT ) ']' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalGHAExpressions.g:1936:36: '.' RULE_ID
            	    {
            	    match('.'); 
            	    mRULE_ID(); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalGHAExpressions.g:1936:48: '[' ( RULE_ID | RULE_INT ) ']'
            	    {
            	    match('['); 
            	    // InternalGHAExpressions.g:1936:52: ( RULE_ID | RULE_INT )
            	    int alt1=2;
            	    ...
            	    switch (alt1) {
            	        case 1 :
            	            // InternalGHAExpressions.g:1936:53: RULE_ID
            	            {
            	            mRULE_ID(); 
            	            ...
            	            break;
            	        case 2 :
            	            // InternalGHAExpressions.g:1936:61: RULE_INT
            	            {
            	            mRULE_INT(); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1938:13: ( RULE_INT '.' RULE_INT )
            // InternalGHAExpressions.g:1938:15: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1940:14: ( ( 'true' | 'false' ) )
            // InternalGHAExpressions.g:1940:16: ( 'true' | 'false' )
            {
            // InternalGHAExpressions.g:1940:16: ( 'true' | 'false' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalGHAExpressions.g:1940:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalGHAExpressions.g:1940:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1942:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )* )
            // InternalGHAExpressions.g:1942:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            {
            // InternalGHAExpressions.g:1942:11: ( '^' )?
            int alt4=2;
            ...
            // InternalGHAExpressions.g:1942:44: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1944:10: ( ( '0' .. '9' )+ )
            // InternalGHAExpressions.g:1944:12: ( '0' .. '9' )+
            {
            // InternalGHAExpressions.g:1944:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalGHAExpressions.g:1944:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1946:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGHAExpressions.g:1946:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGHAExpressions.g:1946:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalGHAExpressions.g:1946:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGHAExpressions.g:1946:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalGHAExpressions.g:1946:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalGHAExpressions.g:1946:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalGHAExpressions.g:1946:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGHAExpressions.g:1946:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                        ...
                        switch (alt8) {
                    	case 1 :
                    	    // InternalGHAExpressions.g:1946:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalGHAExpressions.g:1946:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1948:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGHAExpressions.g:1948:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGHAExpressions.g:1948:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalGHAExpressions.g:1948:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1950:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGHAExpressions.g:1950:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGHAExpressions.g:1950:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalGHAExpressions.g:1950:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalGHAExpressions.g:1950:41: ( '\\r' )? '\\n'
                    {
                    // InternalGHAExpressions.g:1950:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1952:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGHAExpressions.g:1952:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGHAExpressions.g:1952:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGHAExpressions.g:1954:16: ( . )
            // InternalGHAExpressions.g:1954:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\1\uffff\1\25\1\27\1\23\1\32\2\23\3\uffff\1\23\1\42\1\45\2\42\3\23\16\uffff\2\42\1\uffff\1\42\2\uffff\1\45\1\uffff\1\42\4\uffff\2\42\1\61\1\42\1\uffff\1\61";
    static final String DFA15_eofS =
        "\63\uffff";
    static final String DFA15_minS =
        "\1\0\4\75\1\174\1\46\3\uffff\2\55\1\56\2\55\2\0\1\52\16\uffff\2\55\1\uffff\1\55\2\uffff\1\56\1\uffff\1\55\4\uffff\4\55\1\uffff\1\55";
    static final String DFA15_maxS =
        "\1\uffff\4\75\1\174\1\46\3\uffff\2\172\1\71\2\172\2\uffff\1\57\16\uffff\2\172\1\uffff\1\172\2\uffff\1\71\1\uffff\1\172\4\uffff\4\172\1\uffff\1\172";
    static final String DFA15_acceptS =
        "\7\uffff\1\12\1\13\1\14\10\uffff\1\25\1\26\1\2\1\1\1\4\1\3\1\5\1\6\1\11\1\7\1\10\1\12\1\13\1\14\2\uffff\1\20\1\uffff\1\15\1\21\1\uffff\1\16\1\uffff\1\22\1\23\1\24\1\25\4\uffff\1\17\1\uffff";
    static final String DFA15_specialS =
        "\1\0\16\uffff\1\1\1\2\42\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\23\2\22\2\23\1\22\22\23\1\22\1\4\1\17\3\23\1\6\1\20\1\7\1\10\2\23\1\11\1\16\1\23\1\21\12\14\2\23\1\2\1\3\1\1\2\23\32\16\3\23\1\12\1\16\1\23\5\16\1\15\15\16\1\13\6\16\1\23\1\5\uff83\23",
            "\1\24",
            "\1\26",
            "\1\30",
            "\1\31",
