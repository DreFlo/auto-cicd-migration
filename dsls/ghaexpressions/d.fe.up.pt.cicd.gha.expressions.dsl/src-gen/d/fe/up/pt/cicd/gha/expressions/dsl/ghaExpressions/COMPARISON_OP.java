 ...
 * @generated
 */
public enum COMPARISON_OP implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final COMPARISON_OP[] VALUES_ARRAY =
    new COMPARISON_OP[]
    {
      GT,
      GTE,
   ...
   * @generated
   */
  public static final List<COMPARISON_OP> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static COMPARISON_OP get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      COMPARISON_OP result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static COMPARISON_OP getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      COMPARISON_OP result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static COMPARISON_OP get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private COMPARISON_OP(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
