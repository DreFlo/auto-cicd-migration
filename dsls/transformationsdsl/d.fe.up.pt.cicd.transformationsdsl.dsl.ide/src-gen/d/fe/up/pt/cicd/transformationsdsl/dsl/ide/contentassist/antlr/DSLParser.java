...
public class DSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNonConditionalStepAccess().getGroup_0(), "rule__NonConditionalStep__Group_0__0");
			...
			builder.put(grammarAccess.getNonConditionalStepAccess().getProgramAssignment_0_4(), "rule__NonConditionalStep__ProgramAssignment_0_4");
