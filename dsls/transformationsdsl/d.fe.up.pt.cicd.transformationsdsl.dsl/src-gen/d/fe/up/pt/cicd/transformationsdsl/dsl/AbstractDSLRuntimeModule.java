...
import d.fe.up.pt.cicd.transformationsdsl.dsl.parser.antlr.internal.InternalDSLLexer;
import d.fe.up.pt.cicd.transformationsdsl.dsl.scoping.DSLScopeProvider;
import d.fe.up.pt.cicd.transformationsdsl.dsl.serializer.DSLSemanticSequencer;
import d.fe.up.pt.cicd.transformationsdsl.dsl.serializer.DSLSyntacticSequencer;
import d.fe.up.pt.cicd.transformationsdsl.dsl.services.DSLGrammarAccess;
import d.fe.up.pt.cicd.transformationsdsl.dsl.validation.DSLConfigurableIssueCodesProvider;
import d.fe.up.pt.cicd.transformationsdsl.dsl.validation.DSLValidator;
...
public abstract class AbstractDSLRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "d/fe/up/pt/cicd/transformationsdsl/dsl/DSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("d.fe.up.pt.cicd.transformationsdsl.dsl.DSL");
	}
