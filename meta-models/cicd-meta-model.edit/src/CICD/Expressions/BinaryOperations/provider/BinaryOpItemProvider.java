/**
 */
package CICD.Expressions.BinaryOperations.provider;


import CICD.Expressions.BinaryOperations.BinaryOperationsPackage;

import CICD.Expressions.provider.ExpressionItemProvider;
...
/**
 * This is the item provider adapter for a {@link CICD.Expressions.BinaryOperations.BinaryOp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryOp_lhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryOp_lhs_feature", "_UI_BinaryOp_type"),
				 BinaryOperationsPackage.Literals.BINARY_OP__LHS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRhsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BinaryOp_rhs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BinaryOp_rhs_feature", "_UI_BinaryOp_type"),
				 BinaryOperationsPackage.Literals.BINARY_OP__RHS,
				 true,
				 false,
				 true,
				 null,
