/**
 */
package CICD.Expressions.provider;
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assignment_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Assignment_value_feature", "_UI_Assignment_type"),
				 ExpressionsPackage.Literals.ASSIGNMENT__VALUE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.ASSIGNMENT__KEY,
