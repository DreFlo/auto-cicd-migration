/**
 */
package CICD.Matrices.provider;
...
/**
 * This is the item provider adapter for a {@link CICD.Matrices.Matrix} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Matrix_includes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Matrix_includes_feature", "_UI_Matrix_type"),
				 MatricesPackage.Literals.MATRIX__INCLUDES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addExcludesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Matrix_excludes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Matrix_excludes_feature", "_UI_Matrix_type"),
				 MatricesPackage.Literals.MATRIX__EXCLUDES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addFailFastPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Matrix_failFast_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Matrix_failFast_feature", "_UI_Matrix_type"),
				 MatricesPackage.Literals.MATRIX__FAIL_FAST,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MatricesPackage.Literals.MATRIX__AXES,
