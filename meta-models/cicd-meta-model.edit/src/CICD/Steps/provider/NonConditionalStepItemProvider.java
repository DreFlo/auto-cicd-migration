...
/**
 * This is the item provider adapter for a {@link CICD.Steps.NonConditionalStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NonConditionalStepItemProvider extends StepItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NonConditionalStep_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NonConditionalStep_id_feature", "_UI_NonConditionalStep_type"),
				 StepsPackage.Literals.NON_CONDITIONAL_STEP__ID,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NonConditionalStep_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NonConditionalStep_name_feature", "_UI_NonConditionalStep_type"),
				 StepsPackage.Literals.NON_CONDITIONAL_STEP__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NonConditionalStep_environmentVariables_feature", "_UI_NonConditionalStep_type"),
				 StepsPackage.Literals.NON_CONDITIONAL_STEP__ENVIRONMENT_VARIABLES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NonConditionalStep_timeoutMinutes_feature", "_UI_NonConditionalStep_type"),
				 StepsPackage.Literals.NON_CONDITIONAL_STEP__TIMEOUT_MINUTES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_NonConditionalStep_allowFailure_feature", "_UI_NonConditionalStep_type"),
				 StepsPackage.Literals.NON_CONDITIONAL_STEP__ALLOW_FAILURE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NonConditionalStep_type") :
