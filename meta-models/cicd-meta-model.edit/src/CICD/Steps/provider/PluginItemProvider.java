...
/**
 * This is the item provider adapter for a {@link CICD.Steps.Plugin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Plugin_pluginName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Plugin_pluginName_feature", "_UI_Plugin_type"),
				 StepsPackage.Literals.PLUGIN__PLUGIN_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StepsPackage.Literals.PLUGIN__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
