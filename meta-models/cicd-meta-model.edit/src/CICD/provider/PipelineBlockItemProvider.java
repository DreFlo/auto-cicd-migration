...
/**
 * This is the item provider adapter for a {@link CICD.PipelineBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PipelineBlockItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_name_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_inputs_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__INPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_outputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_outputs_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__OUTPUTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTimeoutMinutesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_timeoutMinutes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_timeoutMinutes_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__TIMEOUT_MINUTES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWorkingDirectoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_workingDirectory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_workingDirectory_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__WORKING_DIRECTORY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addConcurrencyGroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_concurrencyGroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_concurrencyGroup_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__CONCURRENCY_GROUP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addShellPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PipelineBlock_shell_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PipelineBlock_shell_feature", "_UI_PipelineBlock_type"),
				 CICDPackage.Literals.PIPELINE_BLOCK__SHELL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PipelineBlock_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CICDPackage.Literals.PIPELINE_BLOCK__AGENT,
				 CICDFactory.eINSTANCE.createAgent()));

		newChildDescriptors.add
			(createChildParameter
				(CICDPackage.Literals.PIPELINE_BLOCK__ENVIRONMENT_VARIABLES,
				 ExpressionsFactory.eINSTANCE.create(ExpressionsPackage.Literals.ASSIGNMENT)));

		newChildDescriptors.add
			(createChildParameter
				(CICDPackage.Literals.PIPELINE_BLOCK__PERMISSIONS,
