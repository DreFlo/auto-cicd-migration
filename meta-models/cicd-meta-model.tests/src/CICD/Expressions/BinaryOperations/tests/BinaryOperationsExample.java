...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>BinaryOperations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaryOperationsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(BinaryOperationsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.binaryoperations"));
				BinaryOp root = BinaryOperationsFactory.eINSTANCE.createBinaryOp();
