...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>BuiltInFunctions</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BuiltInFunctionsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(BuiltInFunctionsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.builtinfunctions"));
				BuiltInFunction root = BuiltInFunctionsFactory.eINSTANCE.createBuiltInFunction();
