...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>UnaryOperations</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryOperationsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(UnaryOperationsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.unaryoperations"));
				UnaryOp root = UnaryOperationsFactory.eINSTANCE.createUnaryOp();
