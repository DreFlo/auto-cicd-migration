...
import CICD.Expressions.BuiltInFunctions.*;
...
public class BuiltInFunctionsFactoryImpl extends EFactoryImpl implements BuiltInFunctionsFactory {
	...
	public static BuiltInFunctionsFactory init() {
		try {
			BuiltInFunctionsFactory theBuiltInFunctionsFactory = (BuiltInFunctionsFactory)EPackage.Registry.INSTANCE.getEFactory(BuiltInFunctionsPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BuiltInFunctionsPackage.BUILT_IN_FUNCTION: return createBuiltInFunction();
			default:
