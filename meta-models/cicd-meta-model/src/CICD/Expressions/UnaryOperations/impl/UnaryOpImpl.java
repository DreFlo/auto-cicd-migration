 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.Expressions.UnaryOperations.impl.UnaryOpImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
		...
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnaryOperationsPackage.UNARY_OP__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
