...
public class UnaryOperationsFactoryImpl extends EFactoryImpl implements UnaryOperationsFactory {
	...
	public static UnaryOperationsFactory init() {
		try {
			UnaryOperationsFactory theUnaryOperationsFactory = (UnaryOperationsFactory)EPackage.Registry.INSTANCE.getEFactory(UnaryOperationsPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case UnaryOperationsPackage.UNARY_OP: return createUnaryOp();
			case UnaryOperationsPackage.NEGATION: return createNegation();
			default:
