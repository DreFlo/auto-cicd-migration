 ...
 * @generated
 */
public class UnaryOperationsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UnaryOperationsPackage.UNARY_OP: {
				...
				if (result == null) result = caseExpression(unaryOp);
			...
			case UnaryOperationsPackage.NEGATION: {
				...
				if (result == null) result = caseUnaryOp(negation);
