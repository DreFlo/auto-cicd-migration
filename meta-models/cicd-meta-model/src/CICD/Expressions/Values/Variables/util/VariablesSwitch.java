...
public class VariablesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case VariablesPackage.ENVIRONMENT_VARIABLE: {
				...
				if (result == null) result = caseValue(environmentVariable);
				if (result == null) result = caseExpression(environmentVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariablesPackage.SECRET_VARIABLE: {
				SecretVariable secretVariable = (SecretVariable)theEObject;
				T result = caseSecretVariable(secretVariable);
				if (result == null) result = caseVariable(secretVariable);
				if (result == null) result = caseValue(secretVariable);
				if (result == null) result = caseExpression(secretVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
