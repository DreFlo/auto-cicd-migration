/**
 */
package CICD.Expressions.util;

import CICD.Expressions.*;
 ...
 * <!-- end-user-doc -->
 * @see CICD.Expressions.ExpressionsPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExpressionsPackage.ASSIGNMENT: {
				@SuppressWarnings("unchecked") Map.Entry<EnvironmentVariable, Expression> assignment = (Map.Entry<EnvironmentVariable, Expression>)theEObject;
