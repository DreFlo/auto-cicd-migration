 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.Matrices.impl.MatrixCombinationImpl#getCombinationEntries <em>Combination Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixCombinationImpl extends MinimalEObjectImpl.Container implements MatrixCombination {
	...
	public EList<Map.Entry<EnvironmentVariable, Expression>> getCombinationEntries() {
		if (combinationEntries == null) {
			combinationEntries = new EObjectResolvingEList<Map.Entry<EnvironmentVariable, Expression>>(Entry.class, this, MatricesPackage.MATRIX_COMBINATION__COMBINATION_ENTRIES);
		}
