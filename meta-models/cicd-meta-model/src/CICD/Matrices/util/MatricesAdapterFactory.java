 ...
 * <!-- end-user-doc -->
 * @see CICD.Matrices.MatricesPackage
 * @generated
 */
public class MatricesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MatricesSwitch<Adapter> modelSwitch =
		new MatricesSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link CICD.Matrices.Matrix <em>Matrix</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CICD.Matrices.MatrixAxis <em>Matrix Axis</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link CICD.Matrices.MatrixCombination <em>Matrix Combination</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
