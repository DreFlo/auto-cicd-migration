 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.Steps.impl.ArtifactImpl#getArtifactName <em>Artifact Name</em>}</li>
 *   <li>{@link CICD.Steps.impl.ArtifactImpl#getIncludePaths <em>Include Paths</em>}</li>
 *   <li>{@link CICD.Steps.impl.ArtifactImpl#getExcludePaths <em>Exclude Paths</em>}</li>
 *   <li>{@link CICD.Steps.impl.ArtifactImpl#getRetentionTime <em>Retention Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactImpl extends NonConditionalStepImpl implements Artifact {
	...
	public NotificationChain basicSetArtifactName(Expression newArtifactName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARTIFACT__ARTIFACT_NAME, oldArtifactName, newArtifactName);
	...
	public void setArtifactName(Expression newArtifactName) {
		if (newArtifactName != artifactName) {
			...
			if (artifactName != null)
				msgs = ((InternalEObject)artifactName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.ARTIFACT__ARTIFACT_NAME, null, msgs);
			if (newArtifactName != null)
				msgs = ((InternalEObject)newArtifactName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.ARTIFACT__ARTIFACT_NAME, null, msgs);
			msgs = basicSetArtifactName(newArtifactName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARTIFACT__ARTIFACT_NAME, newArtifactName, newArtifactName));
	}
	...
	public EList<Expression> getIncludePaths() {
		if (includePaths == null) {
			includePaths = new EObjectContainmentEList<Expression>(Expression.class, this, StepsPackage.ARTIFACT__INCLUDE_PATHS);
		}
		return includePaths;
	}
	...
	public EList<Expression> getExcludePaths() {
		if (excludePaths == null) {
			excludePaths = new EObjectContainmentEList<Expression>(Expression.class, this, StepsPackage.ARTIFACT__EXCLUDE_PATHS);
		}
		return excludePaths;
	}
	...
	public NotificationChain basicSetRetentionTime(Expression newRetentionTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ARTIFACT__RETENTION_TIME, oldRetentionTime, newRetentionTime);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRetentionTime(Expression newRetentionTime) {
		if (newRetentionTime != retentionTime) {
			...
			if (retentionTime != null)
				msgs = ((InternalEObject)retentionTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.ARTIFACT__RETENTION_TIME, null, msgs);
			if (newRetentionTime != null)
				msgs = ((InternalEObject)newRetentionTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.ARTIFACT__RETENTION_TIME, null, msgs);
			msgs = basicSetRetentionTime(newRetentionTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ARTIFACT__RETENTION_TIME, newRetentionTime, newRetentionTime));
	}
