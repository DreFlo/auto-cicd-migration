 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.Steps.impl.CacheImpl#getCacheName <em>Cache Name</em>}</li>
 *   <li>{@link CICD.Steps.impl.CacheImpl#getKeys <em>Keys</em>}</li>
 *   <li>{@link CICD.Steps.impl.CacheImpl#getPaths <em>Paths</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CacheImpl extends NonConditionalStepImpl implements Cache {
	...
	public NotificationChain basicSetCacheName(Expression newCacheName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.CACHE__CACHE_NAME, oldCacheName, newCacheName);
	...
	public void setCacheName(Expression newCacheName) {
		if (newCacheName != cacheName) {
			...
			if (cacheName != null)
				msgs = ((InternalEObject)cacheName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.CACHE__CACHE_NAME, null, msgs);
			if (newCacheName != null)
				msgs = ((InternalEObject)newCacheName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.CACHE__CACHE_NAME, null, msgs);
			msgs = basicSetCacheName(newCacheName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.CACHE__CACHE_NAME, newCacheName, newCacheName));
	}
