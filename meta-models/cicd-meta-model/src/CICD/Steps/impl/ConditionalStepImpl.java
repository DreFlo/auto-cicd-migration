 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.Steps.impl.ConditionalStepImpl#getIf <em>If</em>}</li>
 *   <li>{@link CICD.Steps.impl.ConditionalStepImpl#getThen <em>Then</em>}</li>
 *   <li>{@link CICD.Steps.impl.ConditionalStepImpl#getElse <em>Else</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalStepImpl extends StepImpl implements ConditionalStep {
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.CONDITIONAL_STEP;
	}
	...
	public NotificationChain basicSetIf(Expression newIf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.CONDITIONAL_STEP__IF, oldIf, newIf);
	...
	public void setIf(Expression newIf) {
		if (newIf != if_) {
			...
			if (if_ != null)
				msgs = ((InternalEObject)if_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.CONDITIONAL_STEP__IF, null, msgs);
			if (newIf != null)
				msgs = ((InternalEObject)newIf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.CONDITIONAL_STEP__IF, null, msgs);
			msgs = basicSetIf(newIf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.CONDITIONAL_STEP__IF, newIf, newIf));
	}
	...
	public EList<Step> getThen() {
		if (then == null) {
			then = new EObjectContainmentEList<Step>(Step.class, this, StepsPackage.CONDITIONAL_STEP__THEN);
		}
		return then;
	}
	...
	public EList<Step> getElse() {
		if (else_ == null) {
			else_ = new EObjectContainmentEList<Step>(Step.class, this, StepsPackage.CONDITIONAL_STEP__ELSE);
		}
		return else_;
	}
