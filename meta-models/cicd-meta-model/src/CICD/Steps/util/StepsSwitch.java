...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StepsPackage.CONDITIONAL_STEP: {
			...
			case StepsPackage.COMMAND: {
				...
				if (result == null) result = caseNonConditionalStep(command);
				if (result == null) result = caseStep(command);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.PLUGIN: {
				Plugin plugin = (Plugin)theEObject;
				T result = casePlugin(plugin);
				if (result == null) result = caseNonConditionalStep(plugin);
				if (result == null) result = caseStep(plugin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.CACHE: {
				Cache cache = (Cache)theEObject;
				T result = caseCache(cache);
				if (result == null) result = caseNonConditionalStep(cache);
				if (result == null) result = caseStep(cache);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StepsPackage.ARTIFACT: {
				Artifact artifact = (Artifact)theEObject;
				T result = caseArtifact(artifact);
				if (result == null) result = caseNonConditionalStep(artifact);
				if (result == null) result = caseStep(artifact);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
