	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TriggersPackage.PUSH_TRIGGER: {
				...
				if (result == null) result = caseTrigger(pushTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TriggersPackage.PULL_REQUEST_TRIGGER: {
				...
				if (result == null) result = caseTrigger(pullRequestTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TriggersPackage.MANUAL_TRIGGER: {
				...
				if (result == null) result = caseTrigger(manualTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TriggersPackage.SCHEDULED_TRIGGER: {
				...
				if (result == null) result = caseTrigger(scheduledTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TriggersPackage.WEBHOOK_TRIGGER: {
				...
				if (result == null) result = caseTrigger(webhookTrigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
