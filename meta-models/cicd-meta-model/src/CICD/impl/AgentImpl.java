 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.impl.AgentImpl#getName <em>Name</em>}</li>
 *   <li>{@link CICD.impl.AgentImpl#getContainer <em>Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgentImpl extends MinimalEObjectImpl.Container implements Agent {
	...
	public NotificationChain basicSetContainer(DockerContainer newContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CICDPackage.AGENT__CONTAINER, oldContainer, newContainer);
	...
	public void setContainer(DockerContainer newContainer) {
		if (newContainer != container) {
			...
			if (container != null)
				msgs = ((InternalEObject)container).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CICDPackage.AGENT__CONTAINER, null, msgs);
			if (newContainer != null)
				msgs = ((InternalEObject)newContainer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CICDPackage.AGENT__CONTAINER, null, msgs);
			msgs = basicSetContainer(newContainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.AGENT__CONTAINER, newContainer, newContainer));
	}
