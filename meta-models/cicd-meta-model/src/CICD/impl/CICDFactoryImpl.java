...
public class CICDFactoryImpl extends EFactoryImpl implements CICDFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CICDPackage.PIPELINE: return createPipeline();
			case CICDPackage.JOB: return createJob();
			case CICDPackage.AGENT: return createAgent();
			case CICDPackage.DOCKER_CONTAINER: return createDockerContainer();
			default:
