 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.impl.DockerContainerImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getImage <em>Image</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getRegistryUsername <em>Registry Username</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getRegistryPassword <em>Registry Password</em>}</li>
 *   <li>{@link CICD.impl.DockerContainerImpl#getNetwork <em>Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerContainerImpl extends MinimalEObjectImpl.Container implements DockerContainer {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.DOCKER_CONTAINER;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__LABEL, oldLabel, label));
	}
	...
	public Expression getImage() {
		if (image != null && image.eIsProxy()) {
			...
			if (image != oldImage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.DOCKER_CONTAINER__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImage(Expression newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__IMAGE, oldImage, image));
	}
	...
	public EMap<EnvironmentVariable, Expression> getEnvironmentVariables() {
		if (environmentVariables == null) {
			environmentVariables = new EcoreEMap<EnvironmentVariable,Expression>(ExpressionsPackage.Literals.ASSIGNMENT, AssignmentImpl.class, this, CICDPackage.DOCKER_CONTAINER__ENVIRONMENT_VARIABLES);
		}
	...
	public EList<Expression> getVolumes() {
		if (volumes == null) {
			volumes = new EObjectResolvingEList<Expression>(Expression.class, this, CICDPackage.DOCKER_CONTAINER__VOLUMES);
		}
		return volumes;
	}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__OPTIONS, oldOptions, options));
	}
	...
	public Expression getRegistryUsername() {
		if (registryUsername != null && registryUsername.eIsProxy()) {
			...
			if (registryUsername != oldRegistryUsername) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.DOCKER_CONTAINER__REGISTRY_USERNAME, oldRegistryUsername, registryUsername));
			}
		}
	...
	public void setRegistryUsername(Expression newRegistryUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__REGISTRY_USERNAME, oldRegistryUsername, registryUsername));
	}
	...
	public Expression getRegistryPassword() {
		if (registryPassword != null && registryPassword.eIsProxy()) {
			...
			if (registryPassword != oldRegistryPassword) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.DOCKER_CONTAINER__REGISTRY_PASSWORD, oldRegistryPassword, registryPassword));
			}
		}
	...
	public void setRegistryPassword(Expression newRegistryPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__REGISTRY_PASSWORD, oldRegistryPassword, registryPassword));
	}
	...
	public Expression getNetwork() {
		if (network != null && network.eIsProxy()) {
			...
			if (network != oldNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.DOCKER_CONTAINER__NETWORK, oldNetwork, network));
			}
		}
		return network;
	}
	...
	public void setNetwork(Expression newNetwork) {
		...
		network = newNetwork;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__NETWORK, oldNetwork, network));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CICDPackage.DOCKER_CONTAINER__PORTS:
				return getPorts();
			case CICDPackage.DOCKER_CONTAINER__OPTIONS:
				return getOptions();
			case CICDPackage.DOCKER_CONTAINER__REGISTRY_USERNAME:
				if (resolve) return getRegistryUsername();
				return basicGetRegistryUsername();
			case CICDPackage.DOCKER_CONTAINER__REGISTRY_PASSWORD:
				if (resolve) return getRegistryPassword();
				return basicGetRegistryPassword();
			case CICDPackage.DOCKER_CONTAINER__NETWORK:
