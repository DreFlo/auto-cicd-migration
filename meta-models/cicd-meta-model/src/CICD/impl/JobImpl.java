 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.impl.JobImpl#getId <em>Id</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#getSteps <em>Steps</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#getServices <em>Services</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#getDependsOn <em>Depends On</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#getNecessaryFor <em>Necessary For</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#getMaxAttempts <em>Max Attempts</em>}</li>
 *   <li>{@link CICD.impl.JobImpl#isAllowFailure <em>Allow Failure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JobImpl extends PipelineBlockImpl implements Job {
	...
	public EList<DockerContainer> getServices() {
		if (services == null) {
			services = new EObjectResolvingEList<DockerContainer>(DockerContainer.class, this, CICDPackage.JOB__SERVICES);
		}
		return services;
	}
	...
	public EList<Job> getDependsOn() {
		if (dependsOn == null) {
			dependsOn = new EObjectWithInverseResolvingEList.ManyInverse<Job>(Job.class, this, CICDPackage.JOB__DEPENDS_ON, CICDPackage.JOB__NECESSARY_FOR);
		}
		return dependsOn;
	}
	...
	public EList<Job> getNecessaryFor() {
		if (necessaryFor == null) {
			necessaryFor = new EObjectWithInverseResolvingEList.ManyInverse<Job>(Job.class, this, CICDPackage.JOB__NECESSARY_FOR, CICDPackage.JOB__DEPENDS_ON);
		}
		return necessaryFor;
	}
	...
	public void setMaxAttempts(Integer newMaxAttempts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.JOB__MAX_ATTEMPTS, oldMaxAttempts, maxAttempts));
	}
	...
	public void setAllowFailure(boolean newAllowFailure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.JOB__ALLOW_FAILURE, oldAllowFailure, allowFailure));
	}
