...
import CICD.Expressions.impl.AssignmentImpl;
...
import CICD.Options.impl.PermissionImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getName <em>Name</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getAgent <em>Agent</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getOutputs <em>Outputs</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getPermissions <em>Permissions</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getTimeoutMinutes <em>Timeout Minutes</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getWorkingDirectory <em>Working Directory</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getConcurrencyGroup <em>Concurrency Group</em>}</li>
 *   <li>{@link CICD.impl.PipelineBlockImpl#getShell <em>Shell</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PipelineBlockImpl extends MinimalEObjectImpl.Container implements PipelineBlock {
	 ...
	 * @ordered
	 */
	protected EMap<String, PermissionType> permissions;
	...
	/**
	 * The cached value of the '{@link #getConcurrencyGroup() <em>Concurrency Group</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final ShellType SHELL_EDEFAULT = ShellType.BASH;
	 ...
	 * @ordered
	 */
	protected ShellType shell = SHELL_EDEFAULT;
	...
	public NotificationChain basicSetAgent(Agent newAgent, NotificationChain msgs) {
		...
		agent = newAgent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CICDPackage.PIPELINE_BLOCK__AGENT, oldAgent, newAgent);
	...
	public void setAgent(Agent newAgent) {
		if (newAgent != agent) {
			...
			if (agent != null)
				msgs = ((InternalEObject)agent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CICDPackage.PIPELINE_BLOCK__AGENT, null, msgs);
			if (newAgent != null)
				msgs = ((InternalEObject)newAgent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CICDPackage.PIPELINE_BLOCK__AGENT, null, msgs);
			msgs = basicSetAgent(newAgent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PIPELINE_BLOCK__AGENT, newAgent, newAgent));
	}
	...
	public EList<Input> getInputs() {
		if (inputs == null) {
			inputs = new EObjectResolvingEList<Input>(Input.class, this, CICDPackage.PIPELINE_BLOCK__INPUTS);
		}
		return inputs;
	}
	...
	public EList<Output> getOutputs() {
		if (outputs == null) {
			outputs = new EObjectResolvingEList<Output>(Output.class, this, CICDPackage.PIPELINE_BLOCK__OUTPUTS);
		}
		return outputs;
	}
	...
	public EMap<EnvironmentVariable, Expression> getEnvironmentVariables() {
		if (environmentVariables == null) {
			environmentVariables = new EcoreEMap<EnvironmentVariable,Expression>(ExpressionsPackage.Literals.ASSIGNMENT, AssignmentImpl.class, this, CICDPackage.PIPELINE_BLOCK__ENVIRONMENT_VARIABLES);
		}
	...
	public EMap<String, PermissionType> getPermissions() {
		if (permissions == null) {
			permissions = new EcoreEMap<String,PermissionType>(OptionsPackage.Literals.PERMISSION, PermissionImpl.class, this, CICDPackage.PIPELINE_BLOCK__PERMISSIONS);
		}
		return permissions;
	}
	...
	public void setTimeoutMinutes(Integer newTimeoutMinutes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PIPELINE_BLOCK__TIMEOUT_MINUTES, oldTimeoutMinutes, timeoutMinutes));
	}
	...
	public void setWorkingDirectory(String newWorkingDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PIPELINE_BLOCK__WORKING_DIRECTORY, oldWorkingDirectory, workingDirectory));
	}
	...
	public ConcurrencyGroup getConcurrencyGroup() {
		if (concurrencyGroup != null && concurrencyGroup.eIsProxy()) {
			InternalEObject oldConcurrencyGroup = (InternalEObject)concurrencyGroup;
			concurrencyGroup = (ConcurrencyGroup)eResolveProxy(oldConcurrencyGroup);
			if (concurrencyGroup != oldConcurrencyGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.PIPELINE_BLOCK__CONCURRENCY_GROUP, oldConcurrencyGroup, concurrencyGroup));
			}
		}
	 ...
	 * @generated
	 */
	public ConcurrencyGroup basicGetConcurrencyGroup() {
		return concurrencyGroup;
	}
	...
	public void setConcurrencyGroup(ConcurrencyGroup newConcurrencyGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PIPELINE_BLOCK__CONCURRENCY_GROUP, oldConcurrencyGroup, concurrencyGroup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CICDPackage.PIPELINE_BLOCK__PERMISSIONS:
				if (coreType) return getPermissions();
				else return getPermissions().map();
			...
			case CICDPackage.PIPELINE_BLOCK__CONCURRENCY_GROUP:
				if (resolve) return getConcurrencyGroup();
				return basicGetConcurrencyGroup();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CICDPackage.PIPELINE_BLOCK__TIMEOUT_MINUTES:
				return TIMEOUT_MINUTES_EDEFAULT == null ? timeoutMinutes != null : !TIMEOUT_MINUTES_EDEFAULT.equals(timeoutMinutes);
			case CICDPackage.PIPELINE_BLOCK__WORKING_DIRECTORY:
