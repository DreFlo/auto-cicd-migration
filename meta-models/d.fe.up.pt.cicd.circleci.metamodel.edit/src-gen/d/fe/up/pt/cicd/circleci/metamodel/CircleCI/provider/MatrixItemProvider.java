...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.Matrix} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatrixItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CircleCIPackage.Literals.MATRIX__PARAMETERS);
			childrenFeatures.add(CircleCIPackage.Literals.MATRIX__EXCLUDES);
			childrenFeatures.add(CircleCIPackage.Literals.MATRIX__ALIAS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CircleCIPackage.Literals.MATRIX__PARAMETERS,
				CircleCIFactory.eINSTANCE.createMatrixParameter()));

		newChildDescriptors.add(createChildParameter(CircleCIPackage.Literals.MATRIX__EXCLUDES,
				CircleCIFactory.eINSTANCE.createMatrixCombination()));
