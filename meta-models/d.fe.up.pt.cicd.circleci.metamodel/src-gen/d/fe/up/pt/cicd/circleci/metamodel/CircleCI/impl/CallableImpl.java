 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.CallableImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CallableImpl extends MinimalEObjectImpl.Container implements Callable {
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.CALLABLE;
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this,
					CircleCIPackage.CALLABLE__PARAMETERS);
		}
		return parameters;
	}
