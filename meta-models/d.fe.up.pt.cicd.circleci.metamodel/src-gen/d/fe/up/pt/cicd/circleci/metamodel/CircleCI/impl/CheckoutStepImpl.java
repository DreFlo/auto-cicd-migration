 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.CheckoutStepImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckoutStepImpl extends StepImpl implements CheckoutStep {
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.CHECKOUT_STEP;
	}
	...
	public NotificationChain basicSetPath(Expression newPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CircleCIPackage.CHECKOUT_STEP__PATH, oldPath, newPath);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject) path).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CircleCIPackage.CHECKOUT_STEP__PATH, null, msgs);
			if (newPath != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.CHECKOUT_STEP__PATH, newPath,
					newPath));
	}
