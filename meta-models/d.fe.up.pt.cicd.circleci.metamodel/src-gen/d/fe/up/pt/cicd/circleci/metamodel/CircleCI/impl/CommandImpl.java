 ...
 * @generated
 */
public class CommandImpl extends ScriptImpl implements Command {
	/**
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.COMMAND;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.COMMAND__DESCRIPTION, oldDescription,
					description));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Callable.class) {
			...
			case CircleCIPackage.CALLABLE__PARAMETERS:
				return CircleCIPackage.COMMAND__PARAMETERS;
			default:
				return -1;
			}
		}
