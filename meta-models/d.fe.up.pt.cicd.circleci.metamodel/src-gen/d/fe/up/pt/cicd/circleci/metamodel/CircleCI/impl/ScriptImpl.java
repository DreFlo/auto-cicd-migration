 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.ScriptImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ScriptImpl extends MinimalEObjectImpl.Container implements Script {
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.SCRIPT;
	}
	...
	public EList<Step> getSteps() {
		if (steps == null) {
			steps = new EObjectContainmentEList<Step>(Step.class, this, CircleCIPackage.SCRIPT__STEPS);
		}
		return steps;
	}
