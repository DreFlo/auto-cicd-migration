 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.Tool_FrameworkImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Tool_FrameworkImpl extends MinimalEObjectImpl.Container implements Tool_Framework {
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.TOOL_FRAMEWORK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.TOOL_FRAMEWORK__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CircleCIPackage.TOOL_FRAMEWORK__NAME:
			return getName();
		}
