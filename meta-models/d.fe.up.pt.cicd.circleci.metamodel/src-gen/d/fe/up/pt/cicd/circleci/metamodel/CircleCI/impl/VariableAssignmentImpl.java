 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.VariableAssignmentImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.VariableAssignmentImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableAssignmentImpl extends MinimalEObjectImpl.Container
		implements BasicEMap.Entry<VariableDeclaration, Expression> {
	/**
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.VARIABLE_ASSIGNMENT;
	}
	...
	public NotificationChain basicSetTypedKey(VariableDeclaration newKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CircleCIPackage.VARIABLE_ASSIGNMENT__KEY, oldKey, newKey);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CircleCIPackage.VARIABLE_ASSIGNMENT__KEY, null, msgs);
			if (newKey != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.VARIABLE_ASSIGNMENT__KEY, newKey,
					newKey));
	}
	...
	public NotificationChain basicSetTypedValue(Expression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CircleCIPackage.VARIABLE_ASSIGNMENT__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CircleCIPackage.VARIABLE_ASSIGNMENT__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.VARIABLE_ASSIGNMENT__VALUE, newValue,
					newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CircleCIPackage.VARIABLE_ASSIGNMENT__KEY:
			return basicSetTypedKey(null, msgs);
		case CircleCIPackage.VARIABLE_ASSIGNMENT__VALUE:
