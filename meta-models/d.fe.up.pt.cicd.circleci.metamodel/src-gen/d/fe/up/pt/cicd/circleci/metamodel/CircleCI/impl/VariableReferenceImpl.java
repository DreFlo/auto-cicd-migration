 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.circleci.metamodel.CircleCI.impl.VariableReferenceImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ValueImpl implements VariableReference {
	...
	protected EClass eStaticClass() {
		return CircleCIPackage.Literals.VARIABLE_REFERENCE;
	}
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CircleCIPackage.VARIABLE_REFERENCE__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(VariableDeclaration newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircleCIPackage.VARIABLE_REFERENCE__REFERENCE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CircleCIPackage.VARIABLE_REFERENCE__REFERENCE:
			if (resolve)
				return getReference();
