...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.gha.metamodel.GHA.ScheduleTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleTriggerItemProvider extends TriggerItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createConcat()));

		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createDotOp()));
		...
		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createAnd()));

		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createNot()));
		...
		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createFormat()));

		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createJoin()));

		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createToJSON()));
		...
		newChildDescriptors.add(
				createChildParameter(GHAPackage.Literals.SCHEDULE_TRIGGER__CRONS, GHAFactory.eINSTANCE.createAlways()));
