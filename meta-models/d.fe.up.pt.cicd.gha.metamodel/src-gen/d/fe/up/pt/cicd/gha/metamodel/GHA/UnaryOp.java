 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.UnaryOp#getChildExpr <em>Child Expr</em>}</li>
 * </ul>
 *
 * @see d.fe.up.pt.cicd.gha.metamodel.GHA.GHAPackage#getUnaryOp()
 * @model abstract="true"
 * @generated
 */
public interface UnaryOp extends Expression {
	 ...
	 * @see d.fe.up.pt.cicd.gha.metamodel.GHA.GHAPackage#getUnaryOp_ChildExpr()
	...
	/**
	 * Sets the value of the '{@link d.fe.up.pt.cicd.gha.metamodel.GHA.UnaryOp#getChildExpr <em>Child Expr</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
