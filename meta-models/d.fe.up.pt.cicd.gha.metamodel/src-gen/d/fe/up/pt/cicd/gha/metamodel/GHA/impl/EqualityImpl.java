 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.EqualityImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityImpl extends BinaryOpImpl implements Equality {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.EQUALITY;
	}
	...
	public void setOp(EQUALITY_OPS newOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.EQUALITY__OP, oldOp, op));
	}
