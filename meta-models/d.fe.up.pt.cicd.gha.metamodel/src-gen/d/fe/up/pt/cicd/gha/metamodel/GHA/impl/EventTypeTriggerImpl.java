 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.EventTypeTriggerImpl#getEventTypes <em>Event Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EventTypeTriggerImpl extends TriggerImpl implements EventTypeTrigger {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.EVENT_TYPE_TRIGGER;
	}
	...
	public EList<WEBHOOK_ACTIVITY_TYPES> getEventTypes() {
		if (eventTypes == null) {
			eventTypes = new EDataTypeUniqueEList<WEBHOOK_ACTIVITY_TYPES>(WEBHOOK_ACTIVITY_TYPES.class, this,
					GHAPackage.EVENT_TYPE_TRIGGER__EVENT_TYPES);
		}
		return eventTypes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GHAPackage.EVENT_TYPE_TRIGGER__EVENT_TYPES:
