 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.GitHubContextImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GitHubContextImpl extends ValueImpl implements GitHubContext {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.GIT_HUB_CONTEXT;
	}
	...
	public void setContext(CONTEXTS newContext) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.GIT_HUB_CONTEXT__CONTEXT, oldContext,
					context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GHAPackage.GIT_HUB_CONTEXT__CONTEXT:
			return getContext();
		}
