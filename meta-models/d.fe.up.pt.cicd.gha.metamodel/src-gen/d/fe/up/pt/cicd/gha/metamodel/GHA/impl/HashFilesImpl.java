 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.HashFilesImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HashFilesImpl extends BuiltInFunctionCallImpl implements HashFiles {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.HASH_FILES;
	}
	...
	public NotificationChain basicSetPath(Expression newPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GHAPackage.HASH_FILES__PATH,
					oldPath, newPath);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject) path).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - GHAPackage.HASH_FILES__PATH, null, msgs);
			if (newPath != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.HASH_FILES__PATH, newPath, newPath));
	}
