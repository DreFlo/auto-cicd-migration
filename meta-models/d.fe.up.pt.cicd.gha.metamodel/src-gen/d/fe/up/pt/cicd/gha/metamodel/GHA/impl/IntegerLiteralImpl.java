 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerLiteralImpl extends LiteralImpl implements IntegerLiteral {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setValue(Integer newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.INTEGER_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GHAPackage.INTEGER_LITERAL__VALUE:
			return getValue();
		}
