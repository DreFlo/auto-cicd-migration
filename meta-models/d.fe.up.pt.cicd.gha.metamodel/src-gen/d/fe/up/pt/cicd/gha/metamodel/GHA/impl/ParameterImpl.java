 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ParameterImpl#getId <em>Id</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ParameterImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.PARAMETER;
	}
	...
	public NotificationChain basicSetDescription(Expression newDescription, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GHAPackage.PARAMETER__DESCRIPTION, oldDescription, newDescription);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newDescription != description) {
			...
			if (description != null)
				msgs = ((InternalEObject) description).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - GHAPackage.PARAMETER__DESCRIPTION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.PARAMETER__DESCRIPTION, newDescription,
					newDescription));
	}
