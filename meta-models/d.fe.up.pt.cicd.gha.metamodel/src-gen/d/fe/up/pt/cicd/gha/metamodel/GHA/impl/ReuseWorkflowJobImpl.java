 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ReuseWorkflowJobImpl#getWorkflowPath <em>Workflow Path</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ReuseWorkflowJobImpl#getArgs <em>Args</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ReuseWorkflowJobImpl#getSecrets <em>Secrets</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.gha.metamodel.GHA.impl.ReuseWorkflowJobImpl#getInheritSecrets <em>Inherit Secrets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReuseWorkflowJobImpl extends JobImpl implements ReuseWorkflowJob {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.REUSE_WORKFLOW_JOB;
	}
	...
	public NotificationChain basicSetWorkflowPath(Expression newWorkflowPath, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GHAPackage.REUSE_WORKFLOW_JOB__WORKFLOW_PATH, oldWorkflowPath, newWorkflowPath);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newWorkflowPath != workflowPath) {
			...
			if (workflowPath != null)
				msgs = ((InternalEObject) workflowPath).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - GHAPackage.REUSE_WORKFLOW_JOB__WORKFLOW_PATH, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.REUSE_WORKFLOW_JOB__WORKFLOW_PATH,
	...
	public EMap<String, Expression> getArgs() {
		if (args == null) {
			args = new EcoreEMap<String, Expression>(GHAPackage.Literals.VARIABLE_ASSIGNMENT,
					VariableAssignmentImpl.class, this, GHAPackage.REUSE_WORKFLOW_JOB__ARGS);
		}
		return args;
	}
	...
	public EMap<String, Expression> getSecrets() {
		if (secrets == null) {
			secrets = new EcoreEMap<String, Expression>(GHAPackage.Literals.VARIABLE_ASSIGNMENT,
					VariableAssignmentImpl.class, this, GHAPackage.REUSE_WORKFLOW_JOB__SECRETS);
		}
		return secrets;
	}
	...
	public void setInheritSecrets(Boolean newInheritSecrets) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.REUSE_WORKFLOW_JOB__INHERIT_SECRETS,
