...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.PollingTrigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PollingTriggerItemProvider extends TriggerItemProvider {
	...
	protected void addCronPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PollingTrigger_cron_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PollingTrigger_cron_feature",
								"_UI_PollingTrigger_type"),
						JenkinsPackage.Literals.POLLING_TRIGGER__CRON, true, false, false,
	...
	public String getText(Object object) {
		String label = ((PollingTrigger) object).getCron();
