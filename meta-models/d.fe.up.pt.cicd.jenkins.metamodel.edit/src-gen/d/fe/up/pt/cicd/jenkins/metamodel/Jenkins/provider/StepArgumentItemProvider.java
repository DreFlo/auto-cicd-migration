 ...
 * @generated
 */
public class StepArgumentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public StepArgumentItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JenkinsPackage.Literals.STEP_ARGUMENT__KEY);
			childrenFeatures.add(JenkinsPackage.Literals.STEP_ARGUMENT__VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StepArgument"));
	}
	...
	public String getText(Object object) {
		Map.Entry<?, ?> stepArgument = (Map.Entry<?, ?>) object;
		return "" + stepArgument.getKey() + " -> " + stepArgument.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case JenkinsPackage.STEP_ARGUMENT__KEY:
		case JenkinsPackage.STEP_ARGUMENT__VALUE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(JenkinsPackage.Literals.STEP_ARGUMENT__KEY,
				JenkinsFactory.eINSTANCE.createVariable()));

		newChildDescriptors.add(createChildParameter(JenkinsPackage.Literals.STEP_ARGUMENT__VALUE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == JenkinsPackage.Literals.STEP_ARGUMENT__KEY
				|| childFeature == JenkinsPackage.Literals.STEP_ARGUMENT__VALUE;
