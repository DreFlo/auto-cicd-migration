...
import d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.SUPPORTED_TOOLS;
...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.Tool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addToolPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						JenkinsPackage.Literals.TOOL__TOOL, true, false, false,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Tool_version_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Tool_version_feature", "_UI_Tool_type"),
						JenkinsPackage.Literals.TOOL__VERSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		SUPPORTED_TOOLS labelValue = ((Tool) object).getTool();
	...
	public void notifyChanged(Notification notification) {
		...
		case JenkinsPackage.TOOL__TOOL:
		case JenkinsPackage.TOOL__VERSION:
