 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.BooleanLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralImpl extends LiteralImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return JenkinsPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JenkinsPackage.BOOLEAN_LITERAL__VALUE, oldValue,
					value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JenkinsPackage.BOOLEAN_LITERAL__VALUE:
			return getValue();
		}
