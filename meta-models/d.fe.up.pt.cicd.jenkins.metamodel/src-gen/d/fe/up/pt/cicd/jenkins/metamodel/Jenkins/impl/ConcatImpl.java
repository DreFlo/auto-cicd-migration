 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.ConcatImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConcatImpl extends ExpressionImpl implements Concat {
	...
	protected EClass eStaticClass() {
		return JenkinsPackage.Literals.CONCAT;
	}
	...
	public EList<Expression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Expression>(Expression.class, this,
					JenkinsPackage.CONCAT__EXPRESSIONS);
		}
		return expressions;
	}
