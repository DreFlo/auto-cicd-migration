 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.MatrixAxisImpl#getName <em>Name</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.MatrixAxisImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixAxisImpl extends MinimalEObjectImpl.Container implements MatrixAxis {
	...
	protected EClass eStaticClass() {
		return JenkinsPackage.Literals.MATRIX_AXIS;
	}
	...
	public NotificationChain basicSetName(VariableDeclaration newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JenkinsPackage.MATRIX_AXIS__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JenkinsPackage.MATRIX_AXIS__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JenkinsPackage.MATRIX_AXIS__NAME, newName, newName));
	}
	...
	public EList<Expression> getCells() {
		if (cells == null) {
			cells = new EObjectContainmentEList<Expression>(Expression.class, this, JenkinsPackage.MATRIX_AXIS__CELLS);
		}
		return cells;
	}
