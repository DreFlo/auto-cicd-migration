 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.VariableDereferenceImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.VariableDereferenceImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDereferenceImpl extends ExpressionImpl implements VariableDereference {
	...
	protected EClass eStaticClass() {
		return JenkinsPackage.Literals.VARIABLE_DEREFERENCE;
	}
	...
	public NotificationChain basicSetVariable(Expression newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JenkinsPackage.VARIABLE_DEREFERENCE__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JenkinsPackage.VARIABLE_DEREFERENCE__VARIABLE, null, msgs);
			if (newVariable != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JenkinsPackage.VARIABLE_DEREFERENCE__VARIABLE,
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JenkinsPackage.VARIABLE_DEREFERENCE__PROPERTY,
