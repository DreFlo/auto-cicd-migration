 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.jenkins.metamodel.Jenkins.impl.VariableReferenceImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ExpressionImpl implements VariableReference {
	...
	protected EClass eStaticClass() {
		return JenkinsPackage.Literals.VARIABLE_REFERENCE;
	}
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							JenkinsPackage.VARIABLE_REFERENCE__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(VariableDeclaration newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JenkinsPackage.VARIABLE_REFERENCE__REFERENCE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JenkinsPackage.VARIABLE_REFERENCE__REFERENCE:
			if (resolve)
				return getReference();
