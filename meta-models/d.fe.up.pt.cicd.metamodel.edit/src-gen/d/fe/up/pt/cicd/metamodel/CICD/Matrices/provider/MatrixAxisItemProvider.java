...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.MatrixAxis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatrixAxisItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCellsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MatrixAxis_cells_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MatrixAxis_cells_feature",
								"_UI_MatrixAxis_type"),
						MatricesPackage.Literals.MATRIX_AXIS__CELLS, true, false, true, null, null, null));
	}
