...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.metamodel.CICD.BinaryOp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryOp_lhs_feature",
								"_UI_BinaryOp_type"),
						CICDPackage.Literals.BINARY_OP__LHS, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BinaryOp_rhs_feature",
								"_UI_BinaryOp_type"),
						CICDPackage.Literals.BINARY_OP__RHS, true, false, true, null, null, null));
	}
