...
import d.fe.up.pt.cicd.metamodel.CICD.Expressions.UnaryOperations.Negation;
...
public class UnaryOperationsPackageImpl extends EPackageImpl implements UnaryOperationsPackage {
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Expressions.UnaryOperations.UnaryOperationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static UnaryOperationsPackage init() {
		if (isInited)
			return (UnaryOperationsPackage) EPackage.Registry.INSTANCE.getEPackage(UnaryOperationsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredUnaryOperationsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UnaryOperationsPackageImpl theUnaryOperationsPackage = registeredUnaryOperationsPackage instanceof UnaryOperationsPackageImpl
				? (UnaryOperationsPackageImpl) registeredUnaryOperationsPackage
				: new UnaryOperationsPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEReference(getUnaryOp_Rhs(), theExpressionsPackage.getExpression(), null, "rhs", null, 1, 1, UnaryOp.class,
