 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl.MatrixCombinationImpl#getCombinationEntries <em>Combination Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixCombinationImpl extends MinimalEObjectImpl.Container implements MatrixCombination {
	...
	protected EClass eStaticClass() {
		return MatricesPackage.Literals.MATRIX_COMBINATION;
	}
	...
	public EList<Map.Entry<EnvironmentVariable, Expression>> getCombinationEntries() {
		if (combinationEntries == null) {
			combinationEntries = new EObjectResolvingEList<Map.Entry<EnvironmentVariable, Expression>>(Entry.class,
					this, MatricesPackage.MATRIX_COMBINATION__COMBINATION_ENTRIES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MatricesPackage.MATRIX_COMBINATION__COMBINATION_ENTRIES:
