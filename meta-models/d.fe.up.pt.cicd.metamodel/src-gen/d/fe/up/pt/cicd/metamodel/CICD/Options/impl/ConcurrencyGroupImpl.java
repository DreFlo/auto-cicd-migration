 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Options.impl.ConcurrencyGroupImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Options.impl.ConcurrencyGroupImpl#getCancelInProgress <em>Cancel In Progress</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConcurrencyGroupImpl extends MinimalEObjectImpl.Container implements ConcurrencyGroup {
			...
			if (groupId != oldGroupId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							OptionsPackage.CONCURRENCY_GROUP__GROUP_ID, oldGroupId, groupId));
			}
		}
		return groupId;
	}
	...
	public void setGroupId(Expression newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.CONCURRENCY_GROUP__GROUP_ID,
					oldGroupId, groupId));
	}
