 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Options.impl.PermissionImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Options.impl.PermissionImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PermissionImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String, PermissionType> {
	...
	protected EClass eStaticClass() {
		return OptionsPackage.Literals.PERMISSION;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.PERMISSION__KEY, oldKey, key));
	}
	...
	public void setTypedValue(PermissionType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.PERMISSION__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case OptionsPackage.PERMISSION__KEY:
			return getTypedKey();
		case OptionsPackage.PERMISSION__VALUE:
