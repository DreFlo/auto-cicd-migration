 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getArtifactName <em>Artifact Name</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getIncludePaths <em>Include Paths</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getExcludePaths <em>Exclude Paths</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getRetentionTime <em>Retention Time</em>}</li>
 * </ul>
 *
 * @see d.fe.up.pt.cicd.metamodel.CICD.Steps.StepsPackage#getArtifact()
 * @model
 * @generated
 */
public interface Artifact extends NonConditionalStep {
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Steps.StepsPackage#getArtifact_ArtifactName()
	...
	/**
	 * Sets the value of the '{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getArtifactName <em>Artifact Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Steps.StepsPackage#getArtifact_IncludePaths()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Steps.StepsPackage#getArtifact_ExcludePaths()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Steps.StepsPackage#getArtifact_RetentionTime()
	...
	/**
	 * Sets the value of the '{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.Artifact#getRetentionTime <em>Retention Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
