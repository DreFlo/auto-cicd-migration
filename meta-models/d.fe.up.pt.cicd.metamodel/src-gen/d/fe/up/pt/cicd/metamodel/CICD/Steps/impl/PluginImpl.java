 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.impl.PluginImpl#getPluginName <em>Plugin Name</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.impl.PluginImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Steps.impl.PluginImpl#getKwargs <em>Kwargs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PluginImpl extends NonConditionalStepImpl implements Plugin {
	...
	public void setPluginName(String newPluginName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.PLUGIN__PLUGIN_NAME, oldPluginName,
					pluginName));
	}
