 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Triggers.ScheduledTrigger#getCron <em>Cron</em>}</li>
 * </ul>
 *
 * @see d.fe.up.pt.cicd.metamodel.CICD.Triggers.TriggersPackage#getScheduledTrigger()
 * @model
 * @generated
 */
public interface ScheduledTrigger extends Trigger {
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Triggers.TriggersPackage#getScheduledTrigger_Cron()
	 * @model required="true"
	 * @generated
	 */
