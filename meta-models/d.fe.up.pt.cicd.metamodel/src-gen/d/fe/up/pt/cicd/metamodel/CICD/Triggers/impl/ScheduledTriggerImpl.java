 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Triggers.impl.ScheduledTriggerImpl#getCron <em>Cron</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScheduledTriggerImpl extends TriggerImpl implements ScheduledTrigger {
	...
	protected EClass eStaticClass() {
		return TriggersPackage.Literals.SCHEDULED_TRIGGER;
	}
	...
	public EList<String> getCron() {
		if (cron == null) {
			cron = new EDataTypeUniqueEList<String>(String.class, this, TriggersPackage.SCHEDULED_TRIGGER__CRON);
		}
		return cron;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case TriggersPackage.SCHEDULED_TRIGGER__CRON:
			return getCron();
		}
