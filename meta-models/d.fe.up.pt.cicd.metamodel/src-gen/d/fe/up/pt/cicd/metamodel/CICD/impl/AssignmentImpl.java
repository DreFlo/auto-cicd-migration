 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.AssignmentImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.AssignmentImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignmentImpl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.ASSIGNMENT;
	}
		...
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CICDPackage.ASSIGNMENT__KEY, null, msgs);
			if (newKey != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.ASSIGNMENT__KEY, newKey, newKey));
	}
