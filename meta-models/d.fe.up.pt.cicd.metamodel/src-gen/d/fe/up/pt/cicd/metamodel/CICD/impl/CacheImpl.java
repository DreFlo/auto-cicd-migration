...
public class CacheImpl extends NonConditionalStepImpl implements Cache {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.CACHE;
	}
	...
	public NotificationChain basicSetCacheName(Expression newCacheName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CICDPackage.CACHE__CACHE_NAME, oldCacheName, newCacheName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCacheName != cacheName) {
			...
			if (cacheName != null)
				msgs = ((InternalEObject) cacheName).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CICDPackage.CACHE__CACHE_NAME, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.CACHE__CACHE_NAME, newCacheName,
					newCacheName));
	}
	...
	public EList<Expression> getKeys() {
		if (keys == null) {
			keys = new EObjectContainmentEList<Expression>(Expression.class, this, CICDPackage.CACHE__KEYS);
		}
		return keys;
	}
	...
	public EList<Expression> getPaths() {
		if (paths == null) {
			paths = new EObjectContainmentEList<Expression>(Expression.class, this, CICDPackage.CACHE__PATHS);
		}
		return paths;
	}
