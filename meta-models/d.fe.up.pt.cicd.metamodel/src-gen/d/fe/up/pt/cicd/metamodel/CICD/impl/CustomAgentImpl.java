 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.CustomAgentImpl#getLabels <em>Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomAgentImpl extends AgentImpl implements CustomAgent {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.CUSTOM_AGENT;
	}
	...
	public EList<Expression> getLabels() {
		if (labels == null) {
			labels = new EObjectContainmentEList<Expression>(Expression.class, this, CICDPackage.CUSTOM_AGENT__LABELS);
		}
		return labels;
	}
