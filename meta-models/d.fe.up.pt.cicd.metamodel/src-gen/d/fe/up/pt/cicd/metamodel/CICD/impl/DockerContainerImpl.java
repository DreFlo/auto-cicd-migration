 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getImage <em>Image</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getRegistryUsername <em>Registry Username</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getRegistryPassword <em>Registry Password</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DockerContainerImpl#getNetwork <em>Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerContainerImpl extends MinimalEObjectImpl.Container implements DockerContainer {
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__LABEL, oldLabel,
					label));
	}
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__OPTIONS, oldOptions,
					options));
	}
			...
			if (registryUsername != oldRegistryUsername) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CICDPackage.DOCKER_CONTAINER__REGISTRY_USERNAME, oldRegistryUsername, registryUsername));
			}
		}
	...
	public void setRegistryUsername(Expression newRegistryUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__REGISTRY_USERNAME,
	...
	public Expression getRegistryPassword() {
		if (registryPassword != null && registryPassword.eIsProxy()) {
			...
			if (registryPassword != oldRegistryPassword) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CICDPackage.DOCKER_CONTAINER__REGISTRY_PASSWORD, oldRegistryPassword, registryPassword));
			}
		}
	...
	public void setRegistryPassword(Expression newRegistryPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__REGISTRY_PASSWORD,
	...
	public Expression getNetwork() {
		if (network != null && network.eIsProxy()) {
			...
			if (network != oldNetwork) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.DOCKER_CONTAINER__NETWORK,
							oldNetwork, network));
			}
		}
		return network;
	...
	public void setNetwork(Expression newNetwork) {
		...
		network = newNetwork;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOCKER_CONTAINER__NETWORK, oldNetwork,
					network));
	}
