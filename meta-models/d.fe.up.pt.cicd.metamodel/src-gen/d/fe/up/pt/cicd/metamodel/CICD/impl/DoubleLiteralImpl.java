 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoubleLiteralImpl extends LiteralImpl implements DoubleLiteral {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.DOUBLE_LITERAL;
	}
	...
	public void setValue(Double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.DOUBLE_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CICDPackage.DOUBLE_LITERAL__VALUE:
			return getValue();
		}
