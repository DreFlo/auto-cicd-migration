 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.MacOSAgentImpl#getXcode <em>Xcode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MacOSAgentImpl extends PresetAgentImpl implements MacOSAgent {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.MAC_OS_AGENT;
	}
	...
	public NotificationChain basicSetXcode(Expression newXcode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CICDPackage.MAC_OS_AGENT__XCODE, oldXcode, newXcode);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newXcode != xcode) {
			...
			if (xcode != null)
				msgs = ((InternalEObject) xcode).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CICDPackage.MAC_OS_AGENT__XCODE, null, msgs);
			if (newXcode != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.MAC_OS_AGENT__XCODE, newXcode, newXcode));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CICDPackage.MAC_OS_AGENT__XCODE:
