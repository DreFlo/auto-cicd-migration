 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.PermissionImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.PermissionImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PermissionImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String, PermissionType> {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.PERMISSION;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PERMISSION__KEY, oldKey, key));
	}
