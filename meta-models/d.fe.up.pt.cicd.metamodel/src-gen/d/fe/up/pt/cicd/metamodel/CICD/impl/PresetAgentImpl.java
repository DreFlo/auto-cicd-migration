 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.PresetAgentImpl#getImage <em>Image</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PresetAgentImpl extends AgentImpl implements PresetAgent {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.PRESET_AGENT;
	}
	...
	public NotificationChain basicSetImage(Expression newImage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CICDPackage.PRESET_AGENT__IMAGE, oldImage, newImage);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newImage != image) {
			...
			if (image != null)
				msgs = ((InternalEObject) image).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CICDPackage.PRESET_AGENT__IMAGE, null, msgs);
			if (newImage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.PRESET_AGENT__IMAGE, newImage, newImage));
	}
