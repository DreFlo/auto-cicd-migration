 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.PushTriggerImpl#getTagGlobs <em>Tag Globs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PushTriggerImpl extends TriggerImpl implements PushTrigger {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.PUSH_TRIGGER;
	}
	...
	public EList<String> getTagGlobs() {
		if (tagGlobs == null) {
			tagGlobs = new EDataTypeUniqueEList<String>(String.class, this, CICDPackage.PUSH_TRIGGER__TAG_GLOBS);
		}
		return tagGlobs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CICDPackage.PUSH_TRIGGER__TAG_GLOBS:
			return getTagGlobs();
		}
