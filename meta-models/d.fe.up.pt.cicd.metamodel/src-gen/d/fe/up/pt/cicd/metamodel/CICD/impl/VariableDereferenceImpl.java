 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.VariableDereferenceImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.VariableDereferenceImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDereferenceImpl extends ExpressionImpl implements VariableDereference {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.VARIABLE_DEREFERENCE;
	}
	...
	public NotificationChain basicSetVariable(Expression newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					CICDPackage.VARIABLE_DEREFERENCE__VARIABLE, oldVariable, newVariable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject) variable).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - CICDPackage.VARIABLE_DEREFERENCE__VARIABLE, null, msgs);
			if (newVariable != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.VARIABLE_DEREFERENCE__VARIABLE,
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.VARIABLE_DEREFERENCE__PROPERTY,
