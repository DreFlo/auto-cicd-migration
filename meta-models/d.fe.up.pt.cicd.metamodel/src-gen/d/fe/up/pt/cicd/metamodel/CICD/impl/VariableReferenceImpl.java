 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.impl.VariableReferenceImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ValueImpl implements VariableReference {
	...
	protected EClass eStaticClass() {
		return CICDPackage.Literals.VARIABLE_REFERENCE;
	}
		...
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CICDPackage.VARIABLE_REFERENCE__REFERENCE,
	...
	public void setReference(VariableDeclaration newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CICDPackage.VARIABLE_REFERENCE__REFERENCE,
					oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CICDPackage.VARIABLE_REFERENCE__REFERENCE:
			if (resolve)
				return getReference();
