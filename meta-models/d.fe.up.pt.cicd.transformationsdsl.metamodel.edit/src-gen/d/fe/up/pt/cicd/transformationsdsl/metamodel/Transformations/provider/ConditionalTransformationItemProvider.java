...
/**
 * This is the item provider adapter for a {@link d.fe.up.pt.cicd.transformationsdsl.metamodel.Transformations.ConditionalTransformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalTransformationItemProvider extends TransformationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConditionalTransformationItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ConditionalTransformation) object).getCondition();
		return label == null || label.length() == 0 ? getString("_UI_ConditionalTransformation_type")
				: getString("_UI_ConditionalTransformation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalTransformation.class)) {
