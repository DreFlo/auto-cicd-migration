...
public class ReplaceStepItemProvider extends TIMTransformationItemProvider {
	 ...
	 * @generated
	 */
	public ReplaceStepItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReplaceStep"));
	}
	...
	public String getText(Object object) {
		String label = ((ReplaceStep) object).getJob();
		return label == null || label.length() == 0 ? getString("_UI_ReplaceStep_type")
				: getString("_UI_ReplaceStep_type") + " " + label;
	}
