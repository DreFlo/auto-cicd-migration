...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Change Image</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.transformationsdsl.metamodel.Transformations.impl.ChangeImageImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.transformationsdsl.metamodel.Transformations.impl.ChangeImageImpl#getImage <em>Image</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChangeImageImpl extends OutplaceTransformationImpl implements ChangeImage {
	/**
	...
	protected EClass eStaticClass() {
		return TransformationsPackage.Literals.CHANGE_IMAGE;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationsPackage.CHANGE_IMAGE__CONDITION,
	...
	public void setImage(String newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationsPackage.CHANGE_IMAGE__IMAGE, oldImage,
					image));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ConditionalTransformation.class) {
			...
			case TransformationsPackage.CONDITIONAL_TRANSFORMATION__CONDITION:
				return TransformationsPackage.CHANGE_IMAGE__CONDITION;
			default:
				return -1;
			}
		}
