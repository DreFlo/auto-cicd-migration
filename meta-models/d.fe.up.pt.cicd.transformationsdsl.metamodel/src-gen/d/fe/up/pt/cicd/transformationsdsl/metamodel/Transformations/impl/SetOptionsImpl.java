...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Options</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.transformationsdsl.metamodel.Transformations.impl.SetOptionsImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.transformationsdsl.metamodel.Transformations.impl.SetOptionsImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetOptionsImpl extends InplaceTransformationImpl implements SetOptions {
	/**
	...
	protected EClass eStaticClass() {
		return TransformationsPackage.Literals.SET_OPTIONS;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationsPackage.SET_OPTIONS__CONDITION,
	...
	public void setOptions(String newOptions) {
		...
		options = newOptions;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransformationsPackage.SET_OPTIONS__OPTIONS,
					oldOptions, options));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ConditionalTransformation.class) {
			...
			case TransformationsPackage.CONDITIONAL_TRANSFORMATION__CONDITION:
				return TransformationsPackage.SET_OPTIONS__CONDITION;
			default:
				return -1;
			}
		}
