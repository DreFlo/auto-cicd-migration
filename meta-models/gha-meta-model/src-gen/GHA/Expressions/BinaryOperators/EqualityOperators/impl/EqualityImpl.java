 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.BinaryOperators.EqualityOperators.impl.EqualityImpl#getOp <em>Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualityImpl extends BinaryOpImpl implements Equality {
	...
	protected EClass eStaticClass() {
		return EqualityOperatorsPackage.Literals.EQUALITY;
	}
	...
	public void setOp(EQUALITY_OPS newOp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EqualityOperatorsPackage.EQUALITY__OP, oldOp, op));
	}
