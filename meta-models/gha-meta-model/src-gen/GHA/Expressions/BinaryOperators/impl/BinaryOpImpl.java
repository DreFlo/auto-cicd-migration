 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.BinaryOperators.impl.BinaryOpImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link GHA.Expressions.BinaryOperators.impl.BinaryOpImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BinaryOpImpl extends ExpressionImpl implements BinaryOp {
	...
	protected EClass eStaticClass() {
		return BinaryOperatorsPackage.Literals.BINARY_OP;
	}
	...
	public NotificationChain basicSetLhs(Expression newLhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryOperatorsPackage.BINARY_OP__LHS, oldLhs, newLhs);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLhs != lhs) {
			...
			if (lhs != null)
				msgs = ((InternalEObject) lhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryOperatorsPackage.BINARY_OP__LHS, null, msgs);
			if (newLhs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryOperatorsPackage.BINARY_OP__LHS, newLhs,
					newLhs));
	}
	...
	public NotificationChain basicSetRhs(Expression newRhs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryOperatorsPackage.BINARY_OP__RHS, oldRhs, newRhs);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRhs != rhs) {
			...
			if (rhs != null)
				msgs = ((InternalEObject) rhs).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryOperatorsPackage.BINARY_OP__RHS, null, msgs);
			if (newRhs != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryOperatorsPackage.BINARY_OP__RHS, newRhs,
					newRhs));
	}
