 ...
 * @generated
 */
public class BinaryOperatorsPackageImpl extends EPackageImpl implements BinaryOperatorsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see GHA.Expressions.BinaryOperators.BinaryOperatorsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BinaryOperatorsPackageImpl() {
		super(eNS_URI, BinaryOperatorsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link BinaryOperatorsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BinaryOperatorsPackage init() {
		if (isInited)
			return (BinaryOperatorsPackage) EPackage.Registry.INSTANCE.getEPackage(BinaryOperatorsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBinaryOperatorsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BinaryOperatorsPackageImpl theBinaryOperatorsPackage = registeredBinaryOperatorsPackage instanceof BinaryOperatorsPackageImpl
				? (BinaryOperatorsPackageImpl) registeredBinaryOperatorsPackage
				: new BinaryOperatorsPackageImpl();
		...
		theBinaryOperatorsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BinaryOperatorsPackage.eNS_URI, theBinaryOperatorsPackage);
		return theBinaryOperatorsPackage;
	}
	 ...
	 */
	@Override
	public BinaryOperatorsFactory getBinaryOperatorsFactory() {
		return (BinaryOperatorsFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		EqualityOperatorsPackage theEqualityOperatorsPackage = (EqualityOperatorsPackage) EPackage.Registry.INSTANCE
				.getEPackage(EqualityOperatorsPackage.eNS_URI);
		ComparisonOperatorsPackage theComparisonOperatorsPackage = (ComparisonOperatorsPackage) EPackage.Registry.INSTANCE
				.getEPackage(ComparisonOperatorsPackage.eNS_URI);
		LogicalOperatorsPackage theLogicalOperatorsPackage = (LogicalOperatorsPackage) EPackage.Registry.INSTANCE
				.getEPackage(LogicalOperatorsPackage.eNS_URI);
		ExpressionsPackage theExpressionsPackage = (ExpressionsPackage) EPackage.Registry.INSTANCE
				.getEPackage(ExpressionsPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theEqualityOperatorsPackage);
		getESubpackages().add(theComparisonOperatorsPackage);
		getESubpackages().add(theLogicalOperatorsPackage);
		...
		initEReference(getBinaryOp_Lhs(), theExpressionsPackage.getExpression(), null, "lhs", null, 1, 1,
				BinaryOp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBinaryOp_Rhs(), theExpressionsPackage.getExpression(), null, "rhs", null, 1, 1,
				BinaryOp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
