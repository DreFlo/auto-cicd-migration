 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.ContainsImpl#getSearch <em>Search</em>}</li>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.ContainsImpl#getItem <em>Item</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainsImpl extends BuiltInFunctionCallImpl implements Contains {
	...
	protected EClass eStaticClass() {
		return BuiltInFunctionsPackage.Literals.CONTAINS;
	}
	...
	public NotificationChain basicSetSearch(Expression newSearch, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.CONTAINS__SEARCH, oldSearch, newSearch);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSearch != search) {
			...
			if (search != null)
				msgs = ((InternalEObject) search).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.CONTAINS__SEARCH, null, msgs);
			if (newSearch != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.CONTAINS__SEARCH, newSearch,
					newSearch));
	}
	...
	public NotificationChain basicSetItem(Expression newItem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.CONTAINS__ITEM, oldItem, newItem);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newItem != item) {
			...
			if (item != null)
				msgs = ((InternalEObject) item).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.CONTAINS__ITEM, null, msgs);
			if (newItem != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.CONTAINS__ITEM, newItem,
					newItem));
	}
