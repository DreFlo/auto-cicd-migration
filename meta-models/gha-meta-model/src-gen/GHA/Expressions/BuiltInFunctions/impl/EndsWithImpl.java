 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.EndsWithImpl#getSearchString <em>Search String</em>}</li>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.EndsWithImpl#getSearchValue <em>Search Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndsWithImpl extends BuiltInFunctionCallImpl implements EndsWith {
	...
	protected EClass eStaticClass() {
		return BuiltInFunctionsPackage.Literals.ENDS_WITH;
	}
	...
	public NotificationChain basicSetSearchString(Expression newSearchString, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.ENDS_WITH__SEARCH_STRING, oldSearchString, newSearchString);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSearchString != searchString) {
			...
			if (searchString != null)
				msgs = ((InternalEObject) searchString).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.ENDS_WITH__SEARCH_STRING, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.ENDS_WITH__SEARCH_STRING,
	...
	public NotificationChain basicSetSearchValue(Expression newSearchValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.ENDS_WITH__SEARCH_VALUE, oldSearchValue, newSearchValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newSearchValue != searchValue) {
			...
			if (searchValue != null)
				msgs = ((InternalEObject) searchValue).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.ENDS_WITH__SEARCH_VALUE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.ENDS_WITH__SEARCH_VALUE,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BuiltInFunctionsPackage.ENDS_WITH__SEARCH_STRING:
			return basicSetSearchString(null, msgs);
		case BuiltInFunctionsPackage.ENDS_WITH__SEARCH_VALUE:
