 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.JoinImpl#getArray <em>Array</em>}</li>
 *   <li>{@link GHA.Expressions.BuiltInFunctions.impl.JoinImpl#getSep <em>Sep</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinImpl extends BuiltInFunctionCallImpl implements Join {
	...
	protected EClass eStaticClass() {
		return BuiltInFunctionsPackage.Literals.JOIN;
	}
	...
	public NotificationChain basicSetArray(Expression newArray, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.JOIN__ARRAY, oldArray, newArray);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArray != array) {
			...
			if (array != null)
				msgs = ((InternalEObject) array).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.JOIN__ARRAY, null, msgs);
			if (newArray != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.JOIN__ARRAY, newArray,
					newArray));
	}
	...
	public NotificationChain basicSetSep(Expression newSep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BuiltInFunctionsPackage.JOIN__SEP, oldSep, newSep);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSep(Expression newSep) {
		if (newSep != sep) {
			NotificationChain msgs = null;
			if (sep != null)
				msgs = ((InternalEObject) sep).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.JOIN__SEP, null, msgs);
			if (newSep != null)
				msgs = ((InternalEObject) newSep).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - BuiltInFunctionsPackage.JOIN__SEP, null, msgs);
			msgs = basicSetSep(newSep, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BuiltInFunctionsPackage.JOIN__SEP, newSep, newSep));
	}
