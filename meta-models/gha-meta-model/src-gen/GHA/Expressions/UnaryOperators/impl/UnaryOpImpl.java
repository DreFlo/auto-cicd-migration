 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Expressions.UnaryOperators.impl.UnaryOpImpl#getChildExpr <em>Child Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UnaryOpImpl extends ExpressionImpl implements UnaryOp {
	...
	protected EClass eStaticClass() {
		return UnaryOperatorsPackage.Literals.UNARY_OP;
	}
	...
	public NotificationChain basicSetChildExpr(Expression newChildExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					UnaryOperatorsPackage.UNARY_OP__CHILD_EXPR, oldChildExpr, newChildExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newChildExpr != childExpr) {
			...
			if (childExpr != null)
				msgs = ((InternalEObject) childExpr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - UnaryOperatorsPackage.UNARY_OP__CHILD_EXPR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UnaryOperatorsPackage.UNARY_OP__CHILD_EXPR,
					newChildExpr, newChildExpr));
	}
