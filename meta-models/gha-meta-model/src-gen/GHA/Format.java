 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Format#getString <em>String</em>}</li>
 *   <li>{@link GHA.Format#getReplaceValues <em>Replace Values</em>}</li>
 * </ul>
 *
 * @see GHA.GHAPackage#getFormat()
 * @model
 * @generated
 */
public interface Format extends BuiltInFunctionCall {
	 ...
	 * @see GHA.GHAPackage#getFormat_String()
	...
	/**
	 * Sets the value of the '{@link GHA.Format#getString <em>String</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see GHA.GHAPackage#getFormat_ReplaceValues()
