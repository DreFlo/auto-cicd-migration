 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Jobs.Matrices.impl.MatrixCombinationImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixCombinationImpl extends MinimalEObjectImpl.Container implements MatrixCombination {
	...
	public EMap<String, Expression> getEntries() {
		if (entries == null) {
			entries = new EcoreEMap<String, Expression>(ExpressionsPackage.Literals.VARIABLE_ASSIGNMENT,
					VariableAssignmentImpl.class, this, MatricesPackage.MATRIX_COMBINATION__ENTRIES);
		}
		return entries;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MatricesPackage.MATRIX_COMBINATION__ENTRIES:
