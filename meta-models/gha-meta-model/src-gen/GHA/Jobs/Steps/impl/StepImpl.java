 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getId <em>Id</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getIf <em>If</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getName <em>Name</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getTimeoutMinutes <em>Timeout Minutes</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getContinueOnError <em>Continue On Error</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getShell <em>Shell</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getWorkingDirectory <em>Working Directory</em>}</li>
 *   <li>{@link GHA.Jobs.Steps.impl.StepImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StepImpl extends MinimalEObjectImpl.Container implements Step {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__ID, oldId, id));
	}
	...
	public NotificationChain basicSetIf(Expression newIf, NotificationChain msgs) {
		...
		if_ = newIf;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__IF, oldIf,
					newIf);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setIf(Expression newIf) {
		if (newIf != if_) {
			...
			if (if_ != null)
				msgs = ((InternalEObject) if_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__IF,
						null, msgs);
			if (newIf != null)
				msgs = ((InternalEObject) newIf).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__IF, null,
						msgs);
			msgs = basicSetIf(newIf, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__IF, newIf, newIf));
	}
	...
	public NotificationChain basicSetName(Expression newName, NotificationChain msgs) {
		...
		name = newName;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__NAME,
					oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setName(Expression newName) {
		if (newName != name) {
			NotificationChain msgs = null;
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__NAME,
						null, msgs);
			if (newName != null)
				msgs = ((InternalEObject) newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__NAME,
						null, msgs);
			msgs = basicSetName(newName, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__NAME, newName, newName));
	}
	...
	public NotificationChain basicSetTimeoutMinutes(Expression newTimeoutMinutes, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StepsPackage.STEP__TIMEOUT_MINUTES, oldTimeoutMinutes, newTimeoutMinutes);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTimeoutMinutes != timeoutMinutes) {
			...
			if (timeoutMinutes != null)
				msgs = ((InternalEObject) timeoutMinutes).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__TIMEOUT_MINUTES, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__TIMEOUT_MINUTES, newTimeoutMinutes,
					newTimeoutMinutes));
	}
	...
	public NotificationChain basicSetContinueOnError(Expression newContinueOnError, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StepsPackage.STEP__CONTINUE_ON_ERROR, oldContinueOnError, newContinueOnError);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newContinueOnError != continueOnError) {
			...
			if (continueOnError != null)
				msgs = ((InternalEObject) continueOnError).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__CONTINUE_ON_ERROR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__CONTINUE_ON_ERROR,
	...
	public NotificationChain basicSetShell(Expression newShell, NotificationChain msgs) {
		...
		shell = newShell;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__SHELL,
					oldShell, newShell);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setShell(Expression newShell) {
		if (newShell != shell) {
			NotificationChain msgs = null;
			if (shell != null)
				msgs = ((InternalEObject) shell).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__SHELL,
						null, msgs);
			if (newShell != null)
				msgs = ((InternalEObject) newShell).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__SHELL,
						null, msgs);
			msgs = basicSetShell(newShell, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__SHELL, newShell, newShell));
	}
	...
	public NotificationChain basicSetWorkingDirectory(Expression newWorkingDirectory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StepsPackage.STEP__WORKING_DIRECTORY, oldWorkingDirectory, newWorkingDirectory);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newWorkingDirectory != workingDirectory) {
			...
			if (workingDirectory != null)
				msgs = ((InternalEObject) workingDirectory).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StepsPackage.STEP__WORKING_DIRECTORY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.STEP__WORKING_DIRECTORY,
	...
	public EMap<String, Expression> getEnvironmentVariables() {
		if (environmentVariables == null) {
			environmentVariables = new EcoreEMap<String, Expression>(ExpressionsPackage.Literals.VARIABLE_ASSIGNMENT,
					VariableAssignmentImpl.class, this, StepsPackage.STEP__ENVIRONMENT_VARIABLES);
		}
