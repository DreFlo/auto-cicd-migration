 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getImage <em>Image</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link GHA.Jobs.impl.ContainerImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements GHA.Jobs.Container {
	/**
	...
	protected EClass eStaticClass() {
		return JobsPackage.Literals.CONTAINER;
	}
	...
	public NotificationChain basicSetImage(Expression newImage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JobsPackage.CONTAINER__IMAGE,
					oldImage, newImage);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newImage != image) {
			...
			if (image != null)
				msgs = ((InternalEObject) image).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.CONTAINER__IMAGE, null, msgs);
			if (newImage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.CONTAINER__IMAGE, newImage, newImage));
	}
	...
	public NotificationChain basicSetUsername(Expression newUsername, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JobsPackage.CONTAINER__USERNAME, oldUsername, newUsername);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newUsername != username) {
			...
			if (username != null)
				msgs = ((InternalEObject) username).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.CONTAINER__USERNAME, null, msgs);
			if (newUsername != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.CONTAINER__USERNAME, newUsername,
					newUsername));
	}
	...
	public NotificationChain basicSetPassword(Expression newPassword, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JobsPackage.CONTAINER__PASSWORD, oldPassword, newPassword);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newPassword != password) {
			...
			if (password != null)
				msgs = ((InternalEObject) password).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.CONTAINER__PASSWORD, null, msgs);
			if (newPassword != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.CONTAINER__PASSWORD, newPassword,
					newPassword));
	}
	...
	public EMap<String, Expression> getEnvironmentVariables() {
		if (environmentVariables == null) {
			environmentVariables = new EcoreEMap<String, Expression>(ExpressionsPackage.Literals.VARIABLE_ASSIGNMENT,
					VariableAssignmentImpl.class, this, JobsPackage.CONTAINER__ENVIRONMENT_VARIABLES);
		}
	...
	public EList<Expression> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentEList<Expression>(Expression.class, this, JobsPackage.CONTAINER__PORTS);
		}
		return ports;
	}
	...
	public EList<Expression> getVolumes() {
		if (volumes == null) {
			volumes = new EObjectContainmentEList<Expression>(Expression.class, this, JobsPackage.CONTAINER__VOLUMES);
		}
		return volumes;
	}
	...
	public NotificationChain basicSetOptions(Expression newOptions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JobsPackage.CONTAINER__OPTIONS, oldOptions, newOptions);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newOptions != options) {
			...
			if (options != null)
				msgs = ((InternalEObject) options).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.CONTAINER__OPTIONS, null, msgs);
			if (newOptions != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.CONTAINER__OPTIONS, newOptions,
					newOptions));
	}
