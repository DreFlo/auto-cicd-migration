 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Jobs.impl.StagingEnvironmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link GHA.Jobs.impl.StagingEnvironmentImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StagingEnvironmentImpl extends MinimalEObjectImpl.Container implements StagingEnvironment {
	...
	protected EClass eStaticClass() {
		return JobsPackage.Literals.STAGING_ENVIRONMENT;
	}
	...
	public NotificationChain basicSetName(Expression newName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JobsPackage.STAGING_ENVIRONMENT__NAME, oldName, newName);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newName != name) {
			...
			if (name != null)
				msgs = ((InternalEObject) name).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.STAGING_ENVIRONMENT__NAME, null, msgs);
			if (newName != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.STAGING_ENVIRONMENT__NAME, newName,
					newName));
	}
	...
	public NotificationChain basicSetUrl(Expression newUrl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					JobsPackage.STAGING_ENVIRONMENT__URL, oldUrl, newUrl);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newUrl != url) {
			...
			if (url != null)
				msgs = ((InternalEObject) url).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - JobsPackage.STAGING_ENVIRONMENT__URL, null, msgs);
			if (newUrl != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, JobsPackage.STAGING_ENVIRONMENT__URL, newUrl,
					newUrl));
	}
