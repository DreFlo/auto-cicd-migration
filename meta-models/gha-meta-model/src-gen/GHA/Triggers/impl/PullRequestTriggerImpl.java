 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Triggers.impl.PullRequestTriggerImpl#getEventTypes <em>Event Types</em>}</li>
 *   <li>{@link GHA.Triggers.impl.PullRequestTriggerImpl#getBranches <em>Branches</em>}</li>
 *   <li>{@link GHA.Triggers.impl.PullRequestTriggerImpl#isIgnoreSpecifiedBranches <em>Ignore Specified Branches</em>}</li>
 *   <li>{@link GHA.Triggers.impl.PullRequestTriggerImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link GHA.Triggers.impl.PullRequestTriggerImpl#isIgnoreSpecifiedPaths <em>Ignore Specified Paths</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PullRequestTriggerImpl extends TriggerImpl implements PullRequestTrigger {
	...
	protected EClass eStaticClass() {
		return TriggersPackage.Literals.PULL_REQUEST_TRIGGER;
	}
	...
	public EList<WEBHOOK_ACTIVITY_TYPES> getEventTypes() {
		if (eventTypes == null) {
			eventTypes = new EDataTypeUniqueEList<WEBHOOK_ACTIVITY_TYPES>(WEBHOOK_ACTIVITY_TYPES.class, this,
					TriggersPackage.PULL_REQUEST_TRIGGER__EVENT_TYPES);
		}
		return eventTypes;
	}
	...
	public EList<Expression> getBranches() {
		if (branches == null) {
			branches = new EObjectContainmentEList<Expression>(Expression.class, this,
					TriggersPackage.PULL_REQUEST_TRIGGER__BRANCHES);
		}
		return branches;
	}
	...
	public void setIgnoreSpecifiedBranches(boolean newIgnoreSpecifiedBranches) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TriggersPackage.PULL_REQUEST_TRIGGER__IGNORE_SPECIFIED_BRANCHES, oldIgnoreSpecifiedBranches,
	...
	public EList<Expression> getPaths() {
		if (paths == null) {
			paths = new EObjectContainmentEList<Expression>(Expression.class, this,
					TriggersPackage.PULL_REQUEST_TRIGGER__PATHS);
		}
		return paths;
	}
	...
	public void setIgnoreSpecifiedPaths(boolean newIgnoreSpecifiedPaths) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TriggersPackage.PULL_REQUEST_TRIGGER__IGNORE_SPECIFIED_PATHS, oldIgnoreSpecifiedPaths,
