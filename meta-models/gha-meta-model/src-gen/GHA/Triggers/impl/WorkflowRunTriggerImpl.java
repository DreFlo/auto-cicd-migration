 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.Triggers.impl.WorkflowRunTriggerImpl#getBranches <em>Branches</em>}</li>
 *   <li>{@link GHA.Triggers.impl.WorkflowRunTriggerImpl#isIgnoreSpecifiedBranches <em>Ignore Specified Branches</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowRunTriggerImpl extends TriggerImpl implements WorkflowRunTrigger {
	...
	protected EClass eStaticClass() {
		return TriggersPackage.Literals.WORKFLOW_RUN_TRIGGER;
	}
	...
	public EList<Expression> getBranches() {
		if (branches == null) {
			branches = new EObjectContainmentEList<Expression>(Expression.class, this,
					TriggersPackage.WORKFLOW_RUN_TRIGGER__BRANCHES);
		}
		return branches;
	}
	...
	public void setIgnoreSpecifiedBranches(boolean newIgnoreSpecifiedBranches) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TriggersPackage.WORKFLOW_RUN_TRIGGER__IGNORE_SPECIFIED_BRANCHES, oldIgnoreSpecifiedBranches,
