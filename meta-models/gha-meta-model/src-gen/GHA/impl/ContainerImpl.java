 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.impl.ContainerImpl#getImage <em>Image</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getPorts <em>Ports</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getVolumes <em>Volumes</em>}</li>
 *   <li>{@link GHA.impl.ContainerImpl#getOptions <em>Options</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements GHA.Container {
	/**
