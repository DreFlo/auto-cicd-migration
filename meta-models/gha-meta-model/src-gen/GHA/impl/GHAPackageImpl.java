...
public class GHAPackageImpl extends EPackageImpl implements GHAPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(containerEClass, GHA.Container.class, "Container", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContainer_Image(), this.getExpression(), null, "image", null, 1, 1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Username(), this.getExpression(), null, "username", null, 0, 1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Password(), this.getExpression(), null, "password", null, 0, 1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_EnvironmentVariables(), this.getVariableAssignment(), null, "environmentVariables",
				null, 0, -1, GHA.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Ports(), this.getExpression(), null, "ports", null, 0, -1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Volumes(), this.getExpression(), null, "volumes", null, 0, -1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContainer_Options(), this.getExpression(), null, "options", null, 0, 1, GHA.Container.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(packageEClass, GHA.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Uses(), this.getExpression(), null, "uses", null, 1, 1, GHA.Package.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_Args(), this.getVariableAssignment(), null, "args", null, 0, -1, GHA.Package.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_Entrypoint(), this.getExpression(), null, "entrypoint", null, 0, 1, GHA.Package.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackage_ContainerArgs(), this.getExpression(), null, "containerArgs", null, 0, 1,
				GHA.Package.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(eventsEEnum, GHA.EVENTS.class, "EVENTS");
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.BRANCH_PROTECTION_RULE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.CHECK_RUN);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.CHECK_SUITE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.CREATE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.DELETE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.DEPLOYMENT);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.DEPLOYMENT_STATUS);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.DISCUSSION);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.DISCUSSION_COMMENT);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.FORK);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.GOLLUM);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.ISSUE_COMMENT);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.ISSUES);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.LABEL);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.MERGE_GROUP);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.MILESTONE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PAGE_BUILD);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PROJECT);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PROJECT_CARD);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PROJECT_COLUMN);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PUBLIC);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PULL_REQUEST_REVIEW);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.PULL_REQUEST_REVIEW_COMMENT);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.REGISTRY_PACKAGE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.RELEASE);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.REPOSITORY_DISPATCH);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.STATUS);
		addEEnumLiteral(eventsEEnum, GHA.EVENTS.WATCH);

		initEEnum(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.class, "WEBHOOK_ACTIVITY_TYPES");
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.ASSIGNED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.AUTO_MERGE_DISABLED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.AUTO_MERGE_ENABLED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.CLOSED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.CONVERTED_TO_DRAFT);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.EDITED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.LABELED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.LOCKED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.OPENED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.READY_FOR_REVIEW);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.REOPENED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.REVIEW_REQUEST_REMOVED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.REVIEW_REQUESTED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.SYNCHRONIZE);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.UNASSIGNED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.UNLABELED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.UNLOCKED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.CREATED);
		addEEnumLiteral(webhooK_ACTIVITY_TYPESEEnum, GHA.WEBHOOK_ACTIVITY_TYPES.DELETED);

		initEEnum(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.class, "PERMISSION_SCOPES");
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.ACTIONS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.CHECKS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.CONTENTS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.DEPLOYMENTS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.DISCUSSIONS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.ID_TOKEN);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.ISSUES);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.PACKAGES);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.PAGES);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.PULL_REQUESTS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.REPOSITORY_PROJECTS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.SECURITY_EVENTS);
		addEEnumLiteral(permissioN_SCOPESEEnum, GHA.PERMISSION_SCOPES.STATUSES);

		initEEnum(permissionsEEnum, GHA.PERMISSIONS.class, "PERMISSIONS");
		addEEnumLiteral(permissionsEEnum, GHA.PERMISSIONS.READ);
		addEEnumLiteral(permissionsEEnum, GHA.PERMISSIONS.WRITE);
		addEEnumLiteral(permissionsEEnum, GHA.PERMISSIONS.NONE);

		initEEnum(equalitY_OPSEEnum, GHA.EQUALITY_OPS.class, "EQUALITY_OPS");
		addEEnumLiteral(equalitY_OPSEEnum, GHA.EQUALITY_OPS.EQUALS);
		addEEnumLiteral(equalitY_OPSEEnum, GHA.EQUALITY_OPS.NOT_EQUALS);

		initEEnum(comparisoN_OPSEEnum, GHA.COMPARISON_OPS.class, "COMPARISON_OPS");
		addEEnumLiteral(comparisoN_OPSEEnum, GHA.COMPARISON_OPS.GT);
		addEEnumLiteral(comparisoN_OPSEEnum, GHA.COMPARISON_OPS.GTE);
		addEEnumLiteral(comparisoN_OPSEEnum, GHA.COMPARISON_OPS.LT);
		addEEnumLiteral(comparisoN_OPSEEnum, GHA.COMPARISON_OPS.LTE);

		initEEnum(contextsEEnum, GHA.CONTEXTS.class, "CONTEXTS");
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.GITHUB);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.ENV);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.VARS);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.JOB);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.JOBS);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.STEPS);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.RUNNER);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.SECRETS);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.STRATEGY);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.MATRIX);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.NEEDS);
		addEEnumLiteral(contextsEEnum, GHA.CONTEXTS.INPUTS);

		initEEnum(inpuT_TYPESEEnum, GHA.INPUT_TYPES.class, "INPUT_TYPES");
		addEEnumLiteral(inpuT_TYPESEEnum, GHA.INPUT_TYPES.STRING);
		addEEnumLiteral(inpuT_TYPESEEnum, GHA.INPUT_TYPES.NUMBER);
		addEEnumLiteral(inpuT_TYPESEEnum, GHA.INPUT_TYPES.BOOLEAN);
		addEEnumLiteral(inpuT_TYPESEEnum, GHA.INPUT_TYPES.ENVIRONMENT);
		addEEnumLiteral(inpuT_TYPESEEnum, GHA.INPUT_TYPES.CHOICE);
