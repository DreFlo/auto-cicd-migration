 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.impl.JobImpl#getName <em>Name</em>}</li>
 ...
 *   <li>{@link GHA.impl.JobImpl#getDefaults <em>Defaults</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getServices <em>Services</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getConcurrencyGroup <em>Concurrency Group</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getTimeoutMinutes <em>Timeout Minutes</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getContinueOnError <em>Continue On Error</em>}</li>
 *   <li>{@link GHA.impl.JobImpl#getStrategy <em>Strategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class JobImpl extends MinimalEObjectImpl.Container implements Job {
	 ...
	 * @ordered
	 */
	protected GHA.Container container;
	 ...
	 * @ordered
	 */
	protected EMap<String, GHA.Container> services;
	 ...
	 */
	@Override
	public GHA.Container getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContainer(GHA.Container newContainer, NotificationChain msgs) {
		GHA.Container oldContainer = container;
	 ...
	 */
	@Override
	public void setContainer(GHA.Container newContainer) {
	 ...
	 */
	@Override
	public EMap<String, GHA.Container> getServices() {
		if (services == null) {
			services = new EcoreEMap<String, GHA.Container>(GHAPackage.Literals.SERVICE, ServiceImpl.class, this,
					GHAPackage.JOB__SERVICES);
		}
		return services;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case GHAPackage.JOB__AGENT:
			...
			return;
		case GHAPackage.JOB__CONTAINER:
			setContainer((GHA.Container) newValue);
			return;
		case GHAPackage.JOB__STAGING_ENVIRONMENT:
	...
	public void eUnset(int featureID) {
		...
		case GHAPackage.JOB__AGENT:
			...
			return;
		case GHAPackage.JOB__CONTAINER:
			setContainer((GHA.Container) null);
			return;
		case GHAPackage.JOB__STAGING_ENVIRONMENT:
