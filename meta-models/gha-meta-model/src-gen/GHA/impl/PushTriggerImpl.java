 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.impl.PushTriggerImpl#getBranches <em>Branches</em>}</li>
 *   <li>{@link GHA.impl.PushTriggerImpl#isIgnoreSpecifiedBranches <em>Ignore Specified Branches</em>}</li>
 *   <li>{@link GHA.impl.PushTriggerImpl#getPaths <em>Paths</em>}</li>
 *   <li>{@link GHA.impl.PushTriggerImpl#isIgnoreSpecifiedPaths <em>Ignore Specified Paths</em>}</li>
 *   <li>{@link GHA.impl.PushTriggerImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link GHA.impl.PushTriggerImpl#isIgnoreSpecifiedTags <em>Ignore Specified Tags</em>}</li>
 * </ul>
 *
 * @generated
 */
