 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.impl.StandardEventTriggerImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link GHA.impl.StandardEventTriggerImpl#getEventTypes <em>Event Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardEventTriggerImpl extends TriggerImpl implements StandardEventTrigger {
	...
	protected EClass eStaticClass() {
		return GHAPackage.Literals.STANDARD_EVENT_TRIGGER;
	}
	...
	public void setEvent(EVENTS newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GHAPackage.STANDARD_EVENT_TRIGGER__EVENT, oldEvent,
					event));
	}
