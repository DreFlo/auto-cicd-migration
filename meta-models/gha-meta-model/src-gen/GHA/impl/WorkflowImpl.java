 ...
 * </p>
 * <ul>
 *   <li>{@link GHA.impl.WorkflowImpl#getName <em>Name</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getRunName <em>Run Name</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getTriggers <em>Triggers</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getPermissions <em>Permissions</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getDefaults <em>Defaults</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getEnvironmentVariables <em>Environment Variables</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getConcurrencyGroup <em>Concurrency Group</em>}</li>
 *   <li>{@link GHA.impl.WorkflowImpl#getJobs <em>Jobs</em>}</li>
 * </ul>
 *
 * @generated
 */
