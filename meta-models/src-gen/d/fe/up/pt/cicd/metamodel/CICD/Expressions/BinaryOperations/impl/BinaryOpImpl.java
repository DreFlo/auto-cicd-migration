 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.impl.BinaryOpImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.impl.BinaryOpImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryOpImpl extends ExpressionImpl implements BinaryOp {
		...
		if (lhs != null && lhs.eIsProxy()) {
			...
			if (lhs != oldLhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BinaryOperationsPackage.BINARY_OP__LHS,
							oldLhs, lhs));
			}
		}
		return lhs;
	...
	public Expression getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BinaryOperationsPackage.BINARY_OP__RHS,
							oldRhs, rhs));
			}
		}
		return rhs;
