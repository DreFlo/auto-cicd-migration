/**
 */
package d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.impl;

import d.fe.up.pt.cicd.metamodel.CICD.CICDPackage;

import d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.Addition;
import d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.BinaryOp;
...
import d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.Conjuntion;
import d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.Disjunction;
import d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.Subtraction;
...
public class BinaryOperationsPackageImpl extends EPackageImpl implements BinaryOperationsPackage {
	 ...
	 * @see d.fe.up.pt.cicd.metamodel.CICD.Expressions.BinaryOperations.BinaryOperationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BinaryOperationsPackage init() {
		if (isInited)
			return (BinaryOperationsPackage) EPackage.Registry.INSTANCE.getEPackage(BinaryOperationsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBinaryOperationsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BinaryOperationsPackageImpl theBinaryOperationsPackage = registeredBinaryOperationsPackage instanceof BinaryOperationsPackageImpl
				? (BinaryOperationsPackageImpl) registeredBinaryOperationsPackage
				: new BinaryOperationsPackageImpl();
