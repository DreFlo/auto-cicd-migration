 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Expressions.impl.AssignmentImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Expressions.impl.AssignmentImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssignmentImpl extends MinimalEObjectImpl.Container
	...
	public NotificationChain basicSetTypedKey(EnvironmentVariable newKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ExpressionsPackage.ASSIGNMENT__KEY, oldKey, newKey);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newKey != key) {
			...
			if (key != null)
				msgs = ((InternalEObject) key).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ExpressionsPackage.ASSIGNMENT__KEY, null, msgs);
			if (newKey != null)
	...
	public Expression getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionsPackage.ASSIGNMENT__VALUE,
							oldValue, value));
			}
		}
		return value;
	...
	public void setTypedValue(Expression newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.ASSIGNMENT__VALUE, oldValue,
					value));
	}
