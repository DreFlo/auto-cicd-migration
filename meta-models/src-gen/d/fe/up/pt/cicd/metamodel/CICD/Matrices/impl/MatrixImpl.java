/**
 */
package d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl;

import d.fe.up.pt.cicd.metamodel.CICD.Matrices.MatricesPackage;
import d.fe.up.pt.cicd.metamodel.CICD.Matrices.Matrix;
import d.fe.up.pt.cicd.metamodel.CICD.Matrices.MatrixAxis;
import d.fe.up.pt.cicd.metamodel.CICD.Matrices.MatrixCombination;
 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl.MatrixImpl#getAxes <em>Axes</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl.MatrixImpl#getIncludes <em>Includes</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl.MatrixImpl#getExcludes <em>Excludes</em>}</li>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Matrices.impl.MatrixImpl#getFailFast <em>Fail Fast</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixImpl extends MinimalEObjectImpl.Container implements Matrix {
	...
	public void setFailFast(Boolean newFailFast) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MatricesPackage.MATRIX__FAIL_FAST, oldFailFast,
					failFast));
	}
