 ...
 * <!-- end-user-doc -->
 * @see d.fe.up.pt.cicd.metamodel.CICD.Options.OptionsPackage#getPermissionType()
 * @model
 * @generated
 */
public enum PermissionType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final PermissionType[] VALUES_ARRAY = new PermissionType[] { READ, WRITE, NONE, };
