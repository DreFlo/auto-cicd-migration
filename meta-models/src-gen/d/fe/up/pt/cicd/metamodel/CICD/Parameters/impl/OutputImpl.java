 ...
 * </p>
 * <ul>
 *   <li>{@link d.fe.up.pt.cicd.metamodel.CICD.Parameters.impl.OutputImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends ParameterImpl implements Output {
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParametersPackage.OUTPUT__VALUE, oldValue,
							value));
			}
		}
		return value;
	...
	public void setValue(Value newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParametersPackage.OUTPUT__VALUE, oldValue, value));
	}
